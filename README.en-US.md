...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-22 09:54（UTC+8）。
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 449 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
