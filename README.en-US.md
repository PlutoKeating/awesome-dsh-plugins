...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-23 21:07（UTC+8）。
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2355 | ✅ | Claude Code 风全屏 TUI：鲸鱼顶栏/流式思考/双击 Esc 回滚 |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 941 | ✅ | 内置免费视觉模型路由，给文本 agent 装眼睛 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 458 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1621 | 待定 | 深海鲸鱼养成 |
