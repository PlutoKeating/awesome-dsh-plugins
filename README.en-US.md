...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-22 15:05（UTC+8）。
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5479 | ✅ | Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心 |
...
| [deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) | 866 | ✅ | Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux |
