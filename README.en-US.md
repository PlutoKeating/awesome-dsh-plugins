...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-21 03:06（UTC+8）。
...
| [Bigfish](https://github.com/turtle2209/Bigfish) | 285 | 未测 | 第三方桌面端：内置 Node 运行时，双击即用 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 347 | 需适配 | Chrome 侧栏扩展，让 DSH 直接操作浏览器 |
