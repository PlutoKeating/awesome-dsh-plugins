...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-19 09:56（UTC+8）。
...
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 179 | ✅ | 对话中生成交互式可视化卡片 |
...
| 插件 | ⭐ | 实测 | 说明 |
|---|---:|---|---|
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 300 | 需适配 | Chrome 侧栏扩展，让 DSH 直接操作浏览器 |
