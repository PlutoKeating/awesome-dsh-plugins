...
> 人工策展 50 个高价值插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-08-24 15:33（UTC+8）。
...
| [deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) | 1060 | ✅ | Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 465 | 需适配 | Codex 风格 @file 引用：搜索并挂载工作区文件 |
