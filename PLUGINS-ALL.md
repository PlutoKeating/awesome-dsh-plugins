...
- `[不兼容]` [mstar-harness](https://github.com/btspoony/mstar-harness) 53 — A Skill-driven Harness/Loop Engineering Workflow Agent Plugin
...
- `[可用]` [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) 201 — Cross-agent, local-first persistent memory plugin for DeepSeek Harness (DSH), powered by Mnemon
...
- `[待定]` [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) 123 — DSH plugin: snapshot & rollback your plugin/skin/settings configs
...
- `[可用]` [dsh-market-dsh-market](https://github.com/dsh-market/dsh-market) 2190 — —
...
- `[可用]` [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) 268 — 一站式 DeepSeek Harness 社区发行版：TUI、桌面端与 Web UI 三种形态统一体验，支持分层安装、一步到位，免去手工整合打包
- `[待定]` [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) 233 — dsh-tianshu-tui — DeepSeek Harness terminal UI +harness workflow
...
- `[不兼容]` [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) 101 — DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add（Web界面的skill管理工具）
...
- `[不兼容]` [openma-ai-deepseek-harness-tui](https://github.com/openma-ai/deepseek-harness-tui) 57 — —
...
- `[可用]` [dsh-theme-plugin](https://github.com/nevertoday/dsh-theme-plugin) 20 — —
- `[不兼容]` [dsh-tui-dsh-tui](https://github.com/dsh-tui/dsh-tui) 26 — —
...
- `[未测]` [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) 264 — Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth logi
...
- `[可用]` [bilbillm-deepseek-harness-angelina-themes](https://github.com/bilbillm/deepseek-harness-angelina-themes) 5 — —
...
- `[可用]` [oceanxuikun-dsh-eva-theme-plugin](https://github.com/oceanxuikun/dsh-eva-theme-plugin) 2 — —
...
- `[待定]` [dsh-Solarized](https://github.com/zhijun-dai/dsh-Solarized) 4 — Solarized + Selenized themes for DeepSeek Harness (dsh): four faithful palettes
...
- `[不兼容]` [paean-ai-deeptide](https://github.com/paean-ai/deeptide) 1095 — —
- `[可用]` [nutshellai-tech-mobius](https://github.com/nutshellai-tech/mobius) 285 — —
- `[待定]` [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) 952 — AgentTeams plugin for DeepSeek Harness
- `[不兼容]` [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) 467 — Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their conte
...
- `[待定]` [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) 98 — 把Claude Code的UltraCode模式带给DSH，把 DSH 的一次性多 Agent 调度，升级为可生成、可保存、可治理、可观察、可恢复的 Workflow 层
...
- `[可用]` [dsh-file-review](https://github.com/left0ver/dsh-file-review) 24 — a dsh plugin - review  files that an agent just changed,you can see the diff
...
- `[不兼容]` [franksong2702-dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) 43 — —
...
- `[可用]` [dsh-vision-opencode](https://github.com/poiuyjie/dsh-vision-opencode) 12 — —
...
- `[未测]` [dsh-ssh](https://github.com/UynajGI/dsh-ssh) 7 — SSH remote-execution plugin for DeepSeek Harness: ProxyJump chain, SFTP filesystem, subprocess and PTY over ss
...
- `[未测]` [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) 8 — Deepseek Harness for VS Code
...
- `[可用]` [dsh-codex-provider-plugin](https://github.com/DamonBao/dsh-codex-provider-plugin) 4 — OpenAI Codex provider for DeepSeek Harness with ChatGPT OAuth, native settings, and account usage.
...
- `[可用]` [kalynnka-vscode-deepseek-harness](https://github.com/kalynnka/vscode-deepseek-harness) 3 — —
...
- `[可用]` [dsh-commandcode-provider](https://github.com/Kristin130/dsh-commandcode-provider) 4 — dsh LLM provider plugin for Command Code — every plan incl
...
- `[不兼容]` [openma-ai-open-managed-agents](https://github.com/openma-ai/open-managed-agents) 246 — —
...
- `[可用]` [bowenliang123-dsh-context](https://github.com/bowenliang123/dsh-context) 1001 — —
...
- `[待定]` [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) 163 — Data Agent for DeepSeek Harness: session-scoped database connections with a dedicated agent preset that lets A
- `[未测]` [dsh-work](https://github.com/vibeinging/dsh-work) 631 — Local-first AI workbench for DSH Plugins, combining Agent sessions, project files, data analysis, web research
...
- `[可用]` [dsh-media-skills](https://github.com/akqwpeter-prog/dsh-media-skills) 16 — —
...
- `[可用]` [dsh-lark](https://github.com/omdsh-dev/dsh-lark) 43 — Lark/Feishu IM bot channel for DeepSeek Harness \| 飞书 DeepSeek Harness 插件
...
- `[可用]` [dsh-messager](https://github.com/ly6170/dsh-messager) 4 — 基于Deepseek Harness+DeepSeek开发的适用于Deepseek Harness的消息提醒信使，可使用第三方通道（暂时飞书webhook）进行推送
...
- `[可用]` [surfing-plugin](https://github.com/cyijun/surfing-plugin) 14 — SearXNG search and Crawl4AI fetch providers for DeepSeek Harness
...
- `[可用]` [dsh-files](https://github.com/taxueseek/dsh-files) 22 — DeepSeek Harness dual-face plugin: session-isolated file upload with colorful composer cards + read_document t
...
- `[不兼容]` [dsh-plugin-vision](https://github.com/tdf1995/dsh-plugin-vision) 3 — Vision for text-only LLMs in DeepSeek Harness (DSH): describe images / OCR / VQA
...
- `[可用]` [crafter-station-petdex](https://github.com/crafter-station/petdex) 3968 — —
...
- `[可用]` [liyupi-dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) 85 — —
...
- `[不兼容]` [anywhere-labs-deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) 19648 — —
- `[不兼容]` [dataelement-dsh-desktop](https://github.com/dataelement/dsh-desktop) 2199 — —
- `[可用]` [hairyf-deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) 1102 — —
...
- `[不兼容]` [ningbainb-deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) 186 — —
...
- `[不兼容]` [kelai141-dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) 220 — —
- `[不兼容]` [bruc3van-dsh-desktop](https://github.com/bruc3van/dsh-desktop) 74 — —
...
- `[不兼容]` [ego-browser](https://github.com/Fisfzy/ego-browser) 40 — DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、
...
- `[可用]` [liguobao-dsh-desktop](https://github.com/liguobao/dsh-desktop) 24 — —
- `[可用]` [runzhliu-deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) 35 — —
...
- `[待定]` [sorsama-deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) 40 — —
...
- `[可用]` [anweat-dsh-browser](https://github.com/anweat/dsh-browser) 10 — —
...
- `[可用]` [mapan0424-deepseek-harness-desktop](https://github.com/mapan0424/deepseek-harness-desktop) 2 — —
- `[不兼容]` [microtree9-deepseek-harness-desktop](https://github.com/microtree9/deepseek-harness-desktop) 38 — —
...
- `[不兼容]` [michengai-deepseek-harness-desktop](https://github.com/MichengAI/deepseek-harness-desktop) 20 — —
- `[不兼容]` [minilaba-deepseek-harness-desktop](https://github.com/MiniLaba/deepseek-harness-desktop) 1 — —
- `[可用]` [mrbbbaixue-dsh-desktop](https://github.com/mrbbbaixue/dsh-desktop) 1 — —
...
- `[可用]` [deepseek-ai-deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 191672 — —
- `[可用]` [devin-axis-ipollowork](https://github.com/Devin-AXIS/iPolloWork) 4727 — —
- `[不兼容]` [awesome-dsh-plugin-awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) 12243 — —
...
- `[不兼容]` [0xsline-awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) 882 — —
- `[可用]` [mnemon-dev-mnemon](https://github.com/mnemon-dev/mnemon) 519 — —
- `[不兼容]` [electricitysheep-dsh-handbook](https://github.com/Electricitysheep/dsh-handbook) 655 — —
- `[可用]` [morluto-rea](https://github.com/morluto/rea) 370 — —
- `[可用]` [bruc3van-awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) 272 — —
- `[可用]` [cofy-x-axern](https://github.com/cofy-x/axern) 57 — —
- `[可用]` [humblebanana-open-record-replay](https://github.com/humblebanana/open-record-replay) 140 — —
...
- `[可用]` [drewnekota-cetus](https://github.com/drewnekota/cetus) 130 — —
- `[可用]` [modsearch](https://github.com/liustack/modsearch) 251 — The web plugin for DeepSeek Harness, and the search bridge for every model without native web access
- `[可用]` [sikao-engine-kimix](https://github.com/Sikao-Engine/KimiX) 109 — —
- `[不兼容]` [hikariming-dshfind](https://github.com/hikariming/dshfind) 219 — —
- `[不兼容]` [pulseaiclub-phi](https://github.com/pulseaiclub/phi) 149 — —
- `[可用]` [libukai-awesome-deepseek-harness](https://github.com/libukai/awesome-deepseek-harness) 198 — —
...
- `[可用]` [pingfanfan-hello-dsh](https://github.com/pingfanfan/hello-dsh) 82 — —
...
- `[不兼容]` [oil-oil-dsh-vision](https://github.com/oil-oil/dsh-vision) 86 — —
- `[不兼容]` [laplaceyoung-oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) 53 — —
- `[可用]` [morluto-jacobian](https://github.com/morluto/jacobian) 60 — —
- `[不兼容]` [beancookie-awesome-dsh-plugin](https://github.com/beancookie/awesome-dsh-plugin) 112 — —
...
- `[可用]` [openguardrails-openguardrails](https://github.com/openguardrails/openguardrails) 33 — —
- `[可用]` [cpj-dev-dsh-plugin-cc](https://github.com/cpj-dev/dsh-plugin-cc) 55 — —
...
- `[可用]` [morluto-leantoken](https://github.com/morluto/leantoken) 22 — —
...
- `[可用]` [modusensus-dsh-mneme](https://github.com/modusensus/dsh-mneme) 43 — —
...
- `[可用]` [imsai-sh-awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) 181 — —
...
- `[可用]` [morluto-internalcot](https://github.com/morluto/internalcot) 11 — —
- `[可用]` [nowint-oh-my-dsh](https://github.com/NoWint/Oh-My-DSH) 12 — —
- `[可用]` [railgun0325-dsh-phone](https://github.com/railgun0325/dsh-phone) 16 — —
...
- `[可用]` [dsh-hdc-bridge](https://github.com/1na-ko/dsh-hdc-bridge) 14 — DSH 原生鸿蒙开发助手：hdc 设备闭环调试 + 离线官方知识层（Tier-1 随包）+ DevEco CLI 构建通道 / DSH-native HarmonyOS dev assistant: hdc device
...
- `[不兼容]` [Deepseek-Harness-](https://github.com/Links2008/Deepseek-Harness-) 29 — —
...
- `[可用]` [15828148-dsh-portable-launcher](https://github.com/15828148/dsh-portable-launcher) 1 — —
...
- `[可用]` [freehul-sgme](https://github.com/freehul/sgme) 9 — —
