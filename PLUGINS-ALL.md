...
- `[不兼容]` [mstar-harness](https://github.com/btspoony/mstar-harness) 49 — A Skill-driven Harness/Loop Engineering Workflow Agent Plugin
- `[可用]` [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) 50 — Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/
...
- `[不兼容]` [dsh-record-replay](https://github.com/humblebanana/dsh-record-replay) 8 — DeepSeek Harness record macOS desktop workflows by demonstration and turn them into agent skills (open-record-
...
- `[可用]` [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) 72 — Cross-agent, local-first persistent memory plugin for DeepSeek Harness (DSH), powered by Mnemon
...
- `[待定]` [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) 68 — DSH plugin: snapshot & rollback your plugin/skin/settings configs
...
- `[可用]` [dsh-market-dsh-market](https://github.com/dsh-market/dsh-market) 817 — —
...
- `[可用]` [dsh-web-plugin-manager](https://github.com/LX2000WASD/dsh-web-plugin-manager) 56 — 在 Web UI 中一键管理 DeepSeek Harness (DSH) 插件：查看、实时启停、安装/卸载、环境管理、插件市场
...
- `[可用]` [dsh-market](https://github.com/2BingLing/dsh-market) 19 — DeepSeek Harness 插件市场 · 持续收录 1000+ DSH 插件：中文搜索 + 实用五维评分 + 一键安装
- `[可用]` [ericwong5021-deepseek-plugin-store](https://github.com/Ericwong5021/deepseek-plugin-store) 20 — —
- `[不兼容]` [dsh-melody-launcher](https://github.com/rirko/dsh-melody-launcher) 11 — dsh-旋律启动器：DeepSeek Harness 桌面启动器与插件管理器
- `[可用]` [dsh-plugin-healthcheck](https://github.com/chenw2759-wq/dsh-plugin-healthcheck) 9 — 害怕插件装了就崩溃？用这个插件帮你检测插件是否正常/是否含木马！
...
- `[可用]` [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) 1938 — 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面
- `[可用]` [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) 1804 — 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插件——像素鲸鱼顶栏、实时工作状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表
- `[可用]` [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) 481 — 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups for the DSH Web UI
- `[可用]` [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) 239 — 一站式 DeepSeek Harness 社区发行版：TUI、桌面端与 Web UI 三种形态统一体验，支持分层安装、一步到位，免去手工整合打包
- `[待定]` [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) 202 — dsh-tianshu-tui — DeepSeek Harness terminal UI +harness workflow
- `[可用]` [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) 169 — 在 DSH 对话中生成交互式可视化｜Render model-generated interactive cards inside DSH conversations
- `[可用]` [dsh-genui](https://github.com/omdsh-dev/dsh-genui) 182 — GenUI for DeepSeek Harness: interactive UI components rendered inline in assistant replies via the dsh-ui fenc
- `[可用]` [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) 629 — Eyes for text-only DeepSeek Harness agents: built-in free vision chain (no key) + pixel-level vision tools (Q&
- `[可用]` [dsh-webui-market-plugin](https://github.com/Sanqi-normal/dsh-webui-market-plugin) 78 — dsh Web GUI 社区插件市场：浏览 awesome-dsh-plugin.com 插件目录，一键安装/卸载到 profile
- `[可用]` [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) 69 — DSH Web 选中批注插件：选文字→批注→回车随消息发送；气泡隐藏批注块（零闪烁）；回复按 Annotation N 逐条对照（可悬浮芯片）
- `[不兼容]` [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) 59 — DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add（Web界面的skill管理工具）
- `[不兼容]` [heigeai-deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) 43 — —
...
- `[不兼容]` [openma-ai-deepseek-harness-tui](https://github.com/openma-ai/deepseek-harness-tui) 36 — —
- `[不兼容]` [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) 40 — OpenBiliClaw 是本地运行的跨平台个性化内容推荐 Agent，持续理解你的兴趣并主动找内容
- `[可用]` [147228-dsh-xiaoyao-skins](https://github.com/147228/dsh-xiaoyao-skins) 24 — —
- `[待定]` [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) 23 — DSH Web UI plugin: auto-sends 「继续」 to resume requests interrupted by network errors or other non-human causes
- `[可用]` [dsh-theme](https://github.com/oil-oil/dsh-theme) 23 — Live theme editor for DeepSeek Harness with curated palettes and typography controls.
...
- `[可用]` [dsh-theme-plugin](https://github.com/nevertoday/dsh-theme-plugin) 17 — —
- `[不兼容]` [dsh-tui-dsh-tui](https://github.com/dsh-tui/dsh-tui) 18 — —
...
- `[可用]` [dsh-plugin-better-sidebar-plugin-office](https://github.com/HuanLinOTO/dsh-plugin-better-sidebar-plugin-office) 18 — 为 better-sidebar 提供 Office 三件套预览（.docx/.xlsx/.pptx），独立 bundle 瘦身主体 \| Provides Office-suite preview (.docx/.xls
...
- `[可用]` [dsh-context-doctor](https://github.com/Zhenyu98/dsh-context-doctor) 12 — DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重复与冲突；Web UI 圆环面板 + context_audit 工具
...
- `[可用]` [dsh-portable-tavern](https://github.com/XCNXNXNX/dsh-portable-tavern) 15 — DeepSeek Harness 的「便携酒馆」插件：RPG 式 SillyTavern V2/V3 角色卡生成器 + 酒馆角色扮演聊天
...
- `[未测]` [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) 10 — Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth logi
...
- `[可用]` [renat3u-tonghuashun-webui](https://github.com/renat3u/tonghuashun-webui) 3 — —
...
- `[不兼容]` [dsh-token-viewer](https://github.com/qwert702/dsh-token-viewer) 2 — DSH web GUI plugin: live token consumption surfaces (composer dock strip + sideb
...
- `[未测]` [TokenTracker](https://github.com/xiufengsun/TokenTracker) 1347 — Local-first AI token usage & cost tracker for 31 coding tools incl
- `[不兼容]` [paean-ai-deeptide](https://github.com/paean-ai/deeptide) 1076 — —
- `[可用]` [nutshellai-tech-mobius](https://github.com/nutshellai-tech/mobius) 284 — —
- `[待定]` [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) 491 — AgentTeams plugin for DeepSeek Harness
- `[不兼容]` [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) 327 — Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their conte
- `[可用]` [DSH-Plugins-Marketplace](https://github.com/bradeGithub/DSH-Plugins-Marketplace) 114 — DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub topic:dsh-plugin 的全部插件 \| brows
- `[可用]` [Liang-Saint-Slider](https://github.com/BruzWJ/Liang-Saint-Slider) 85 — Liang Saint Slider as the DeepSeek Harness model + thinking-effort selector.
- `[不兼容]` [kuangre123-codex-switch](https://github.com/kuangre123/codex-switch) 67 — —
- `[待定]` [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) 74 — 把Claude Code的UltraCode模式带给DSH，把 DSH 的一次性多 Agent 调度，升级为可生成、可保存、可治理、可观察、可恢复的 Workflow 层
...
- `[可用]` [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) 57 — 从Claude Code、Codex、Reasonix等Agent工具导入迁移历史消息，并在DeepSeek Harness(DSH)中继续对话
- `[不兼容]` [hongfeiyucode-deepseek-harness-desktop](https://github.com/hongfeiyucode/deepseek-harness-desktop) 38 — —
- `[待定]` [dsh-find-plugin](https://github.com/awesome-dsh-plugin/dsh-find-plugin) 49 — Find DSH plugins inside the agent — live GitHub dsh-plugin topic search, star-ranked / 会话内搜索发现 DSH 插件
- `[可用]` [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) 53 — Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support
...
- `[不兼容]` [dsh-milestone](https://github.com/SnowCrescenter-tech/dsh-milestone) 17 — Git-style milestone timeline for DeepSeek Harness - hover for metadata, click to jump to any message
...
- `[不兼容]` [dsh-diff-viewer](https://github.com/lehhair/dsh-diff-viewer) 17 — DSH Web GUI PiUI-style diff viewer plugin: replaces the stock DiffBlock for write/edit tool calls via ui-tool
...
- `[不兼容]` [franksong2702-dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) 22 — —
...
- `[可用]` [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) 21 — Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides wh
...
- `[待定]` [deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) 13 — deepseek-harness for vscode .This is a community project, and we welcome your valuable feedback!
- `[可用]` [dsh-llm-codebuddy](https://github.com/Axiaohungry/dsh-llm-codebuddy) 13 — 在deepseek harness中使用workbuddy api，因为公司只提供workbuddy积分
...
- `[待定]` [task-passport](https://github.com/dongsheng123132/task-passport) 9 — Open task handoff protocol for DeepSeek Harness, WorkBuddy, Claude Code and Codex — verified state, not chat l
...
- `[可用]` [deepseek-harness-vsc-extension](https://github.com/weinibuliu/deepseek-harness-vsc-extension) 18 — DeepSeek Harness for VS Code as extension
...
- `[可用]` [dsh-codex-provider](https://github.com/Hu9956/dsh-codex-provider) 6 — OpenAI Codex provider for DeepSeek Harness with device-code OAuth, Codex CLI import, token refresh, and a web
...
- `[可用]` [dsh-token-usage](https://github.com/LeemanCheung/dsh-token-usage) 10 — Persistent token usage records and dashboard for DeepSeek Harness
...
- `[可用]` [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) 23 — Second-model AI auto-review for DeepSeek Harness approval requests: a read-only
- `[待定]` [dsh-permission-rules](https://github.com/PerryLink/dsh-permission-rules) 7 — Claude Code-style declarative permission rules for DeepSeek Harness: ordered allow/deny/ask rules with tool-na
...
- `[可用]` [dsh-file-mentions](https://github.com/a903067276-rgb/dsh-file-mentions) 8 — Clickable file paths in DSH replies: Codex-style inline open, 📂 reveal in file m
...
- `[未测]` [dsh-openai-codex-auth](https://github.com/yoke233/dsh-openai-codex-auth) 5 — OpenAI Codex OAuth login and usage card plugin for DeepSeek Harness
...
- `[可用]` [foryourhealth111-pixel-vibe-skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) 2872 — —
- `[可用]` [modlens](https://github.com/liustack/modlens) 2778 — The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent
- `[不兼容]` [anionex-agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) 995 — —
- `[可用]` [hellowind777-helloagents](https://github.com/hellowind777/helloagents) 688 — —
- `[可用]` [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) 614 — Open-source CMA-compatible agent runtime for any model, with MCP tools, sandboxed sessions, audit, replay, and
- `[不兼容]` [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) 615 — 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜DeepSeek Harness-native integration for agent-vision
- `[不兼容]` [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) 333 — Open-source alternative to Claude Cowork — a local-first AI agent desktop app · multi-model · self-evolving sk
- `[可用]` [linhay-harmony-next-skills](https://github.com/linhay/harmony-next.skills) 328 — —
- `[不兼容]` [openma-ai-open-managed-agents](https://github.com/openma-ai/open-managed-agents) 237 — —
- `[可用]` [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) 153 — 为 DeepSeek Harness 带来「跨会话长期记忆 + 后台自我进化」能力的纯插件实现：五轨记忆 · git 分支感知 · 回合内自我审查 · 技能自我进化与技能管理器 · 四轨待办 · COI 调度 · 会话广 〔PR〕
...
- `[可用]` [bowenliang123-dsh-context](https://github.com/bowenliang123/dsh-context) 183 — —
- `[不兼容]` [dsh-automation](https://github.com/titanwings/dsh-automation) 49 — DSH 自动化插件：让 Coding 任务按计划在全新 Agent Session 中运行，并由用户或 Agent 创建和管理定时任务
- `[待定]` [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) 40 — Data Agent for DeepSeek Harness: session-scoped database connections with a dedicated agent preset that lets A
- `[未测]` [dsh-work](https://github.com/vibeinging/dsh-work) 310 — Local-first AI workbench for DSH Plugins, combining Agent sessions, project files, data analysis, web research
- `[待定]` [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) 96 — —
- `[不兼容]` [atlascloudai-atlas-cloud-skills](https://github.com/AtlasCloudAI/atlas-cloud-skills) 23 — —
- `[可用]` [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) 29 — Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authoriz
- `[不兼容]` [dsh-plugin-session-delete](https://github.com/lsz-asd/dsh-plugin-session-delete) 22 — Delete DeepSeek Harness sessions from the UI: header danger button + sidebar session-row menu item (no convers
- `[可用]` [dsh-auto-memory](https://github.com/Aik358/dsh-auto-memory) 13 — DSH 自动记忆插件:三层记忆(用户级/项目笔记/每日日志)自动注入与检索、每日反思、可视化面板与设置页,支持继承其他 AI 工具的历史记忆
- `[可用]` [dsh-whale-report](https://github.com/SenmuuuuW/dsh-whale-report) 20 — 🐋 鲸鱼记事本 — 你的 Agent 年度报告：从会话事件日志生成日报/周报/月报/年报，任意区间、只读不改写
...
- `[可用]` [omdsh-dev-dsh-plugin-skills](https://github.com/omdsh-dev/dsh-plugin-skills) 10 — —
- `[可用]` [dsh-plugin-product-subagents](https://github.com/shaokeyibb/dsh-plugin-product-subagents) 16 — Role-based Codex / Claude Code / ACP subagent providers for the DeepSeek Harness — continuable children, durab
...
- `[可用]` [dsh-session-notification](https://github.com/dingyi222666/dsh-session-notification) 12 — 提供会话完成等四种状态的通知响应，支持浏览器提示和提示词
...
- `[可用]` [dsh-plugin-langfuse](https://github.com/linyp/dsh-plugin-langfuse) 8 — Langfuse observability for DeepSeek Harness (dsh): exports agent sessions as OpenTelemetry trace trees (GenAI
...
- `[可用]` [weshop-dsh-plugin](https://github.com/weshopai/weshop-dsh-plugin) 10 — Native WeShop Cordis plugin for DeepSeek Harness
- `[待定]` [dsh-harness-mcp-server](https://github.com/chushixixin/dsh-harness-mcp-server) 6 — Expose DeepSeek Harness agent capabilities as an MCP server (brain=Hermes, arms=Harness)
...
- `[待定]` [dsh-noema](https://github.com/ZSeven-W/dsh-noema) 97 — Noema long-term memory plugin for DSH: durable, inspectable agent memory with recall tools and a settings page
...
- `[可用]` [dsh-skill-importer](https://github.com/saitamahang/dsh-skill-importer) 1 — deepSeek Harness plugin: import and manage skills from files or URLs, with a com
...
- `[可用]` [dsh-message-edit](https://github.com/Moeblack/dsh-message-edit) 29 — DSH plugin: branch-based message editing, reroll, retry, version timeline
- `[可用]` [dsh-lark](https://github.com/omdsh-dev/dsh-lark) 30 — Lark/Feishu IM bot channel for DeepSeek Harness \| 飞书 DeepSeek Harness 插件
...
- `[不兼容]` [dingkaihu63-dsh-robotic-harness](https://github.com/dingkaihu63/dsh-robotic-harness) 13 — —
- `[可用]` [deepseek-manners](https://github.com/Moeblack/deepseek-manners) 13 — DSH 插件：给每次消息后注入感谢语（deepseek-manners）
- `[待定]` [dsh-qq2006](https://github.com/LaplaceYoung/dsh-qq2006) 12 — DSH (DeepSeek Harness) 的 QQ2006 皮肤插件：注册 qq2006 主题、镜像 body[data-ds-skin]、全局皮肤表与完整素材
...
- `[未测]` [dsh-codex](https://github.com/Yan-Zero/dsh-codex) 19 — Use your ChatGPT subscription in DeepSeek Harness through OpenAI's Codex sign-in
...
- `[可用]` [dsh-messager](https://github.com/ly6170/dsh-messager) 3 — 基于Deepseek Harness+DeepSeek开发的适用于Deepseek Harness的消息提醒信使，可使用第三方通道（暂时飞书webhook）进行推送
...
- `[可用]` [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) 9 — 在 DeepSeek Harness 中使用 ChatGPT/Codex 订阅，支持 OAuth 登录、额度与重置时间 \| ChatGPT/Codex subs
...
- `[可用]` [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) 107 — OpenPencil design preview and editing plugin for DSH
- `[待定]` [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) 34 — 向模型暴露 MinerU 文档解析工具，将 PDF/图片/DOCX/PPTX/XLSX 转为结构化 Markdown/JSON \| Exposes MinerU document-parsing tools to the
...
- `[可用]` [dsh-web-search-pro](https://github.com/anweat/dsh-web-search-pro) 21 — Enhanced, persistent web search plugin for DeepSeek Harness (multi-engine search, SQLite+LRU cache, platform b
...
- `[不兼容]` [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) 13 — OpenMAIC for DeepSeek Harness: classrooms, slides, interactive widgets, and Socratic teaching
...
- `[可用]` [dsh-usage-stats](https://github.com/lanlandeli/dsh-usage-stats) 9 — DeepSeek Harness 使用统计插件｜Token 总量与构成、7/30 天趋势、年度活跃热力图、模型占比、工作区/任务筛选、CSV/JSON 导出
...
- `[不兼容]` [dsh-file-mount](https://github.com/acefun29/dsh-file-mount) 4 — —
...
- `[可用]` [dsh-files](https://github.com/taxueseek/dsh-files) 8 — DeepSeek Harness dual-face plugin: session-isolated file upload with colorful composer cards + read_document t
...
- `[可用]` [crafter-station-petdex](https://github.com/crafter-station/petdex) 3877 — —
- `[待定]` [small-tailqwq-dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) 1248 — —
- `[可用]` [whale-girl](https://github.com/vlln/whale-girl) 222 — DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴
- `[不兼容]` [pc2005-cloud-dsh-pet](https://github.com/PC2005-cloud/dsh-pet) 88 — —
- `[可用]` [liyupi-dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) 54 — —
- `[可用]` [awu12277-dsh-stock-watch](https://github.com/Awu12277/dsh-stock-watch) 44 — —
- `[可用]` [deepseek-pet](https://github.com/keleus/deepseek-pet) 29 — 在你的deepseek-harness上养一只吃白饭的大蓝鲸
- `[待定]` [dsh-emoji](https://github.com/hellodigua/dsh-emoji) 24 — 让 AI 回复加入自定义表情，支持Bilibili、小红书、贴吧、知乎等多平台表情包，或自定义表情
- `[可用]` [dsh-minigames](https://github.com/lhh010/dsh-minigames) 22 — DSH Web UI 右侧小游戏面板：18 款离线小游戏（恐龙跳一跳 / 俄罗斯方块 / 坦克大战 / 扫雷 / 2048 / 数独 / 吃豆人 / 跟枪练习等），可扩展游戏注册表，等待模型回复或修 bug 时的摸鱼神器
- `[不兼容]` [huanlinoto-dsh-plugin-pet-rs](https://github.com/HuanLinOTO/dsh-plugin-pet-rs) 18 — —
...
- `[可用]` [dsh-answer-pet](https://github.com/Nanki-nn/dsh-answer-pet) 8 — —
...
- `[可用]` [DeepSeek-Harness-Pet](https://github.com/minybear/DeepSeek-Harness-Pet) 5 — Codex-style desktop pet plugin for DeepSeek Harness
...
- `[不兼容]` [anywhere-labs-deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) 11565 — —
- `[不兼容]` [dataelement-dsh-desktop](https://github.com/dataelement/dsh-desktop) 765 — —
- `[可用]` [hairyf-deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) 421 — —
- `[可用]` [sepinetam-mcp-for-stata](https://github.com/SepineTam/mcp-for-stata) 245 — —
- `[不兼容]` [lum1104-dsh-browser](https://github.com/Lum1104/dsh-browser) 251 — —
- `[未测]` [Bigfish](https://github.com/turtle2209/Bigfish) 254 — Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带桌面萌宠
- `[待定]` [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) 109 — DSH桌面端，支持主题和背景图等多种个性化配置
- `[不兼容]` [ningbainb-deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) 78 — —
- `[可用]` [dsh-notification](https://github.com/omdsh-dev/dsh-notification) 57 — Desktop notifications for DeepSeek Harness turn completions, with per-outcome controls and include/exclude key
- `[不兼容]` [kelai141-dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) 66 — —
- `[不兼容]` [bruc3van-dsh-desktop](https://github.com/bruc3van/dsh-desktop) 54 — —
- `[可用]` [hanelalo-browser-bridge](https://github.com/hanelalo/browser-bridge) 37 — —
...
- `[不兼容]` [ego-browser](https://github.com/Fisfzy/ego-browser) 22 — DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、
- `[可用]` [cc1252-deepseek-harness-desktop](https://github.com/cc1252/deepseek-harness-desktop) 19 — —
- `[可用]` [flymysql-dsh-remote](https://github.com/flymysql/dsh-remote) 17 — —
- `[不兼容]` [dsh-mobile](https://github.com/lehhair/dsh-mobile) 17 — —
- `[可用]` [liguobao-dsh-desktop](https://github.com/liguobao/dsh-desktop) 17 — —
- `[可用]` [runzhliu-deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) 19 — —
...
- `[可用]` [lbwnb666-ai-deepseekharnessremotegateway](https://github.com/lbwnb666-ai/DeepSeekHarnessRemoteGateway) 16 — —
...
- `[可用]` [cloud-1104-deepseek-harness-desktop](https://github.com/cloud-1104/deepseek-harness-desktop) 8 — —
...
- `[待定]` [sorsama-deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) 13 — —
...
- `[可用]` [ankocd-dsh-server-deployment](https://github.com/AnkoCD/dsh-server-deployment) 6 — —
...
- `[可用]` [anweat-dsh-browser](https://github.com/anweat/dsh-browser) 5 — —
...
- `[不兼容]` [microtree9-deepseek-harness-desktop](https://github.com/microtree9/deepseek-harness-desktop) 4 — —
...
- `[不兼容]` [huangj17-deepseek-harness-desktop](https://github.com/huangj17/deepseek-harness-desktop) 5 — —
...
- `[可用]` [hx876298682-tech-deepseek-harness-desktop](https://github.com/hx876298682-tech/deepseek-harness-desktop) 2 — —
...
- `[不兼容]` [singleone-deepseek-harness-desktop](https://github.com/SingleOne/deepseek-harness-desktop) 2 — —
...
- `[可用]` [alaliqing-claude-paper](https://github.com/alaliqing/claude-paper) 317 — —
...
- `[可用]` [deepseek-ai-deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 149000 — —
- `[可用]` [devin-axis-ipollowork](https://github.com/Devin-AXIS/iPolloWork) 4106 — —
- `[不兼容]` [awesome-dsh-plugin-awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) 7523 — —
- `[不兼容]` [imsai-sh-zhuzhiliao](https://github.com/imsai-sh/zhuzhiliao) 2830 — —
- `[可用]` [adamplatin123-awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) 1140 — —
- `[可用]` [PicGo-Core](https://github.com/PicGo/PicGo-Core) 976 — :zap:The ultimate image uploading engine
- `[不兼容]` [0xsline-awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) 687 — —
- `[可用]` [mnemon-dev-mnemon](https://github.com/mnemon-dev/mnemon) 469 — —
- `[不兼容]` [electricitysheep-dsh-handbook](https://github.com/Electricitysheep/dsh-handbook) 449 — —
- `[可用]` [morluto-rea](https://github.com/morluto/rea) 347 — —
- `[可用]` [bruc3van-awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) 210 — —
- `[可用]` [cofy-x-axern](https://github.com/cofy-x/axern) 56 — —
...
- `[不兼容]` [ruler4396-dsh-launcher](https://github.com/Ruler4396/dsh-launcher) 133 — —
- `[可用]` [nagi-ovo-dsh-find-plugins](https://github.com/Nagi-ovo/dsh-find-plugins) 141 — —
- `[可用]` [drewnekota-cetus](https://github.com/drewnekota/cetus) 116 — —
- `[可用]` [modsearch](https://github.com/liustack/modsearch) 132 — The web plugin for DeepSeek Harness, and the search bridge for every model without native web access
- `[可用]` [sikao-engine-kimix](https://github.com/Sikao-Engine/KimiX) 106 — —
- `[不兼容]` [hikariming-dshfind](https://github.com/hikariming/dshfind) 134 — —
- `[不兼容]` [pulseaiclub-phi](https://github.com/pulseaiclub/phi) 102 — —
- `[可用]` [libukai-awesome-deepseek-harness](https://github.com/libukai/awesome-deepseek-harness) 115 — —
- `[不兼容]` [dominic789654-awesome-deepseek-harness](https://github.com/Dominic789654/awesome-deepseek-harness) 123 — —
...
- `[可用]` [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) 76 — deepseek harness对话和代码状态回退插件 \| DSH — rewind conversation and workspace state, powered by a persistent Change Le
- `[可用]` [ayase34-gal-view](https://github.com/Ayase34/gal-view) 86 — —
- `[可用]` [pingfanfan-hello-dsh](https://github.com/pingfanfan/hello-dsh) 68 — —
- `[可用]` [lyn-77-promentor](https://github.com/Lyn-77/ProMentor) 60 — —
- `[可用]` [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) 84 — AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH)
- `[可用]` [dsh-toy](https://github.com/c3ll256/dsh-toy) 54 — Toy Control Protocol for DSH
- `[不兼容]` [oil-oil-dsh-vision](https://github.com/oil-oil/dsh-vision) 63 — —
- `[不兼容]` [laplaceyoung-oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) 50 — —
- `[可用]` [morluto-jacobian](https://github.com/morluto/jacobian) 51 — —
- `[不兼容]` [beancookie-awesome-dsh-plugin](https://github.com/beancookie/awesome-dsh-plugin) 76 — —
- `[可用]` [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) 70 — DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步
- `[不兼容]` [like-study1-oh-my-dsh](https://github.com/like-study1/Oh-My-DSH) 56 — —
...
- `[可用]` [noob-stupid-dsh-plugin-hub](https://github.com/Noob-stupid/dsh-plugin-hub) 40 — —
- `[可用]` [openguardrails-openguardrails](https://github.com/openguardrails/openguardrails) 27 — —
- `[可用]` [cpj-dev-dsh-plugin-cc](https://github.com/cpj-dev/dsh-plugin-cc) 3 — —
- `[不兼容]` [kuangre123-iosdev](https://github.com/kuangre123/iosdev) 24 — —
- `[不兼容]` [n0zom1z0-th08](https://github.com/N0zoM1z0/th08) 29 — —
...
- `[可用]` [morluto-leantoken](https://github.com/morluto/leantoken) 19 — —
- `[不兼容]` [kejixiaoliang-awesome-dsh-plugins](https://github.com/kejixiaoliang/awesome-dsh-plugins) 20 — —
...
- `[待定]` [dsh-scholar](https://github.com/lzszq/dsh-scholar) 21 — dsh-scholar
...
- `[待定]` [dsh-balance-meter](https://github.com/Ghost011118/dsh-balance-meter) 16 — DeepSeek account balance and session cost readout for the DeepSeek Harness Web GUI
- `[可用]` [modusensus-dsh-mneme](https://github.com/modusensus/dsh-mneme) 22 — —
...
- `[可用]` [biociao-dsh-science](https://github.com/biociao/dsh-science) 15 — —
...
- `[可用]` [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) 20 — A DeepSeek Harness (dsh) web plugin that replaces the "Deep diving…" turn-status label with phase-aware, typew
- `[不兼容]` [fakechris-dsh-harness-ops](https://github.com/fakechris/dsh-harness-ops) 11 — —
- `[可用]` [imsai-sh-awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) 58 — —
...
- `[不兼容]` [omdsh-dev-dsh-plugin-dev](https://github.com/omdsh-dev/dsh-plugin-dev) 12 — —
...
- `[不兼容]` [bin-hy-dsh](https://github.com/Bin-hy/dsh) 11 — —
...
- `[可用]` [dsh-client-pricing](https://github.com/Miyazawai/dsh-client-pricing) 13 — 会话顶栏实时显示 DeepSeek API 价格（峰谷定价 / 现行一口价，flash / pro 自动切换） \| DeepSeek Harness client plugin: live DeepSeek API pr
...
- `[待定]` [small-tailqwq-dsh-deepcel](https://github.com/Small-tailqwq/dsh-deepcel) 10 — —
- `[可用]` [dsh-web-billing](https://github.com/bpc-oss/dsh-web-billing) 9 — RMB/USD token-billing plugin for DeepSeek Harness (dsh web): official-policy auto pricing with peak/off-peak h
...
- `[可用]` [dsh-spotlight](https://github.com/0xsline/dsh-spotlight) 7 — Keyboard-first command palette for DeepSeek Harness Web
...
- `[不兼容]` [Deepseek-Harness-](https://github.com/Links2008/Deepseek-Harness-) 20 — —
- `[待定]` [dsh-llm-fallbacks](https://github.com/omdsh-dev/dsh-llm-fallbacks) 7 — An dsh plugin for role-based LLM retry&fallback strategy
...
- `[不兼容]` [oitsukiii-deepseek-harness-lan](https://github.com/oitsukiii/deepseek-harness-lan) 5 — —
...
- `[可用]` [coppynight-dsh-doctor](https://github.com/coppynight/dsh-doctor) 4 — —
...
- `[待定]` [TokenLedger](https://github.com/zh667/TokenLedger) 24 — Token usage accounting for DeepSeek Harness, reconciled against New API and Sub2API relay-site billing
...
- `[不兼容]` [dsh-vision-bridge](https://github.com/GXX182/dsh-vision-bridge) 2 — DeepSeek Harness plugin that bridges session images to pluggable vision APIs whi
