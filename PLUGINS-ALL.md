...
- `[可用]` [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) 409 — Cross-agent, local-first persistent memory plugin for DeepSeek Harness (DSH), powered by Mnemon
...
- `[待定]` [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) 165 — DSH plugin: snapshot & rollback your plugin/skin/settings configs
...
- `[可用]` [dsh-market-dsh-market](https://github.com/dsh-market/dsh-market) 4506 — —
...
- `[不兼容]` [dsh-melody-launcher](https://github.com/rirko/dsh-melody-launcher) 30 — dsh-旋律启动器：DeepSeek Harness 桌面启动器与插件管理器
...
- `[可用]` [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) 3743 — 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面
- `[可用]` [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) 3175 — 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插件——像素鲸鱼顶栏、实时工作状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表
...
- `[可用]` [dsh-genui](https://github.com/omdsh-dev/dsh-genui) 479 — GenUI for DeepSeek Harness: interactive UI components rendered inline in assistant replies via the dsh-ui fenc
...
- `[不兼容]` [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) 148 — DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add（Web界面的skill管理工具）
...
- `[未测]` [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) 382 — Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth logi
...
- `[未测]` [TokenTracker](https://github.com/xiufengsun/TokenTracker) 1719 — Local-first AI token usage & cost tracker for 31 coding tools incl
...
- `[待定]` [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) 1798 — AgentTeams plugin for DeepSeek Harness
...
- `[待定]` [dsh-find-plugin](https://github.com/awesome-dsh-plugin/dsh-find-plugin) 143 — Find DSH plugins inside the agent — live GitHub dsh-plugin topic search, star-ranked / 会话内搜索发现 DSH 插件
- `[可用]` [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) 323 — Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support
...
- `[不兼容]` [franksong2702-dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) 119 — —
...
- `[可用]` [dsh-llm-codebuddy](https://github.com/Axiaohungry/dsh-llm-codebuddy) 49 — 在deepseek harness中使用workbuddy api，因为公司只提供workbuddy积分
...
- `[待定]` [dsh-vsc-integration](https://github.com/HarcoChen/dsh-vsc-integration) 16 — Deepseek-Harness Vscode Integration
...
- `[可用]` [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) 198 — Second-model AI auto-review for DeepSeek Harness approval requests: a read-only
...
- `[未测]` [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) 23 — —
...
- `[可用]` [dsh-github](https://github.com/PerryLink/dsh-github) 17 — GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write
...
- `[可用]` [foryourhealth111-pixel-vibe-skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) 3437 — —
- `[可用]` [modlens](https://github.com/liustack/modlens) 4027 — The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent
- `[不兼容]` [anionex-agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) 1210 — —
- `[可用]` [hellowind777-helloagents](https://github.com/hellowind777/helloagents) 704 — —
- `[可用]` [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) 669 — Open-source CMA-compatible agent runtime for any model, with MCP tools, sandboxed sessions, audit, replay, and
...
- `[不兼容]` [openma-ai-open-managed-agents](https://github.com/openma-ai/open-managed-agents) 304 — —
- `[可用]` [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) 331 — 为 DeepSeek Harness 带来「跨会话长期记忆 + 后台自我进化」能力的纯插件实现：五轨记忆 · git 分支感知 · 回合内自我审查 · 技能自我进化与技能管理器 · 四轨待办 · COI 调度 · 会话广 〔PR〕
...
- `[可用]` [bowenliang123-dsh-context](https://github.com/bowenliang123/dsh-context) 1521 — —
...
- `[可用]` [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) 166 — Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authoriz
...
- `[待定]` [dsh-science-workbench](https://github.com/poplarity/dsh-science-workbench) 10 — A reproducible science workbench plugin for the DeepSeek Harness: agent-driven cells, inline figures with feed
...
- `[未测]` [dsh-expression](https://github.com/yyh-001/dsh-expression) 108 — 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道
...
- `[可用]` [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) 94 — 在 DeepSeek Harness 中使用 ChatGPT/Codex 订阅，支持 OAuth 登录、额度与重置时间 \| ChatGPT/Codex subs
...
- `[可用]` [crafter-station-petdex](https://github.com/crafter-station/petdex) 4156 — —
- `[待定]` [small-tailqwq-dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) 2201 — —
- `[可用]` [whale-girl](https://github.com/vlln/whale-girl) 335 — DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴
- `[不兼容]` [pc2005-cloud-dsh-pet](https://github.com/PC2005-cloud/dsh-pet) 753 — —
...
- `[可用]` [dsh-memento](https://github.com/PerryLink/dsh-memento) 117 — Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.me
...
- `[不兼容]` [anywhere-labs-deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) 28867 — —
- `[不兼容]` [dataelement-dsh-desktop](https://github.com/dataelement/dsh-desktop) 9093 — —
- `[可用]` [hairyf-deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) 2610 — —
- `[可用]` [sepinetam-mcp-for-stata](https://github.com/SepineTam/mcp-for-stata) 260 — —
- `[不兼容]` [lum1104-dsh-browser](https://github.com/Lum1104/dsh-browser) 726 — —
...
- `[不兼容]` [ningbainb-deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) 715 — —
...
- `[不兼容]` [kelai141-dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) 530 — —
...
- `[不兼容]` [ego-browser](https://github.com/Fisfzy/ego-browser) 190 — DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、
- `[可用]` [cc1252-deepseek-harness-desktop](https://github.com/cc1252/deepseek-harness-desktop) 19 — —
- `[可用]` [flymysql-dsh-remote](https://github.com/flymysql/dsh-remote) 97 — —
...
- `[可用]` [deepseek-ai-deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 235116 — —
- `[可用]` [devin-axis-ipollowork](https://github.com/Devin-AXIS/iPolloWork) 6665 — —
- `[不兼容]` [awesome-dsh-plugin-awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) 16825 — —
...
- `[可用]` [mnemon-dev-mnemon](https://github.com/mnemon-dev/mnemon) 594 — —
...
- `[可用]` [modsearch](https://github.com/liustack/modsearch) 541 — The web plugin for DeepSeek Harness, and the search bridge for every model without native web access
...
- `[不兼容]` [pulseaiclub-phi](https://github.com/pulseaiclub/phi) 513 — —
...
- `[可用]` [ayase34-gal-view](https://github.com/Ayase34/gal-view) 189 — —
...
- `[可用]` [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) 335 — DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步
...
- `[可用]` [modusensus-dsh-mneme](https://github.com/modusensus/dsh-mneme) 120 — —
...
- `[可用]` [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) 89 — A DeepSeek Harness (dsh) web plugin that replaces the "Deep diving…" turn-status label with phase-aware, typew
...
- `[可用]` [pi2dsh](https://github.com/weijiafu14/pi2dsh) 205 — Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plu
...
- `[可用]` [dsh-multi-tenant](https://github.com/GuoMonth/dsh-multi-tenant) 13 — Multi-tenant SaaS extension for DeepSeek Harness (DSH): tenant identity, session isolation, authorization, ten
...
- `[可用]` [perrylink-dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) 41 — —
