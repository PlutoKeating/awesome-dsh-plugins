...
- `[不兼容]` [mstar-harness](https://github.com/btspoony/mstar-harness) 60 — A Skill-driven Harness/Loop Engineering Workflow Agent Plugin
- `[可用]` [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) 90 — Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/
...
- `[可用]` [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) 379 — Cross-agent, local-first persistent memory plugin for DeepSeek Harness (DSH), powered by Mnemon
...
- `[待定]` [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) 158 — DSH plugin: snapshot & rollback your plugin/skin/settings configs
...
- `[可用]` [dsh-market-dsh-market](https://github.com/dsh-market/dsh-market) 4030 — —
...
- `[可用]` [dsh-market](https://github.com/2BingLing/dsh-market) 112 — DeepSeek Harness 插件市场 · 持续收录 1000+ DSH 插件：中文搜索 + 实用五维评分 + 一键安装
...
- `[可用]` [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) 3628 — 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面
- `[可用]` [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) 3069 — 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插件——像素鲸鱼顶栏、实时工作状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表
- `[可用]` [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) 626 — 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups for the DSH Web UI
- `[可用]` [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) 317 — 一站式 DeepSeek Harness 社区发行版：TUI、桌面端与 Web UI 三种形态统一体验，支持分层安装、一步到位，免去手工整合打包
- `[待定]` [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) 278 — dsh-tianshu-tui — DeepSeek Harness terminal UI +harness workflow
...
- `[可用]` [dsh-genui](https://github.com/omdsh-dev/dsh-genui) 461 — GenUI for DeepSeek Harness: interactive UI components rendered inline in assistant replies via the dsh-ui fenc
- `[可用]` [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) 1105 — Eyes for text-only DeepSeek Harness agents: built-in free vision chain (no key) + pixel-level vision tools (Q&
...
- `[可用]` [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) 121 — DSH Web 选中批注插件：选文字→批注→回车随消息发送；气泡隐藏批注块（零闪烁）；回复按 Annotation N 逐条对照（可悬浮芯片）
- `[不兼容]` [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) 131 — DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add（Web界面的skill管理工具）
...
- `[待定]` [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) 98 — DSH Web UI plugin: auto-sends 「继续」 to resume requests interrupted by network errors or other non-human causes
...
- `[可用]` [dsh-mcp-panel](https://github.com/PerryLink/dsh-mcp-panel) 61 — Read-only runtime management panel for the official DeepSeek Harness MCP client: /mcp command + Settings MCP t
...
- `[可用]` [perrylink-dsh-plugin-guide](https://github.com/PerryLink/dsh-plugin-guide) 40 — —
...
- `[未测]` [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) 367 — Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth logi
...
- `[未测]` [TokenTracker](https://github.com/xiufengsun/TokenTracker) 1633 — Local-first AI token usage & cost tracker for 31 coding tools incl
...
- `[待定]` [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) 1690 — AgentTeams plugin for DeepSeek Harness
...
- `[待定]` [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) 126 — 把Claude Code的UltraCode模式带给DSH，把 DSH 的一次性多 Agent 调度，升级为可生成、可保存、可治理、可观察、可恢复的 Workflow 层
...
- `[可用]` [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) 166 — 从Claude Code、Codex、Reasonix等Agent工具导入迁移历史消息，并在DeepSeek Harness(DSH)中继续对话
- `[不兼容]` [hongfeiyucode-deepseek-harness-desktop](https://github.com/hongfeiyucode/deepseek-harness-desktop) 36 — —
- `[待定]` [dsh-find-plugin](https://github.com/awesome-dsh-plugin/dsh-find-plugin) 139 — Find DSH plugins inside the agent — live GitHub dsh-plugin topic search, star-ranked / 会话内搜索发现 DSH 插件
- `[可用]` [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) 273 — Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support
...
- `[不兼容]` [franksong2702-dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) 108 — —
...
- `[可用]` [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) 97 — Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides wh
- `[不兼容]` [icodesign-orbis](https://github.com/icodesign/orbis) 15 — —
- `[可用]` [dsh-bash-terminal](https://github.com/MAXeaglet/dsh-bash-terminal) 20 — —
- `[待定]` [deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) 147 — deepseek-harness for vscode .This is a community project, and we welcome your valuable feedback!
...
- `[待定]` [task-passport](https://github.com/dongsheng123132/task-passport) 10 — Open task handoff protocol for DeepSeek Harness, WorkBuddy, Claude Code and Codex — verified state, not chat l
...
- `[可用]` [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) 172 — Second-model AI auto-review for DeepSeek Harness approval requests: a read-only
...
- `[可用]` [inmny-dsh-git-bash](https://github.com/inmny/dsh-git-bash) 14 — —
...
- `[可用]` [dsh-github](https://github.com/PerryLink/dsh-github) 12 — GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write
...
- `[未测]` [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) 25 — Deepseek Harness for VS Code
- `[未测]` [dsh-checkpoint-rewind](https://github.com/PerryLink/dsh-checkpoint-rewind) 17 — Claude Code /rewind for DeepSeek Harness — git-first workspace snapshots before every mutation, turn-boundary
...
- `[可用]` [dsh-gateway-provider](https://github.com/Luck9Star/dsh-gateway-provider) 4 — —
...
- `[可用]` [foryourhealth111-pixel-vibe-skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) 3315 — —
- `[可用]` [modlens](https://github.com/liustack/modlens) 3975 — The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent
- `[不兼容]` [anionex-agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) 1209 — —
...
- `[可用]` [linhay-harmony-next-skills](https://github.com/linhay/harmony-next.skills) 349 — —
- `[不兼容]` [openma-ai-open-managed-agents](https://github.com/openma-ai/open-managed-agents) 282 — —
- `[可用]` [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) 312 — 为 DeepSeek Harness 带来「跨会话长期记忆 + 后台自我进化」能力的纯插件实现：五轨记忆 · git 分支感知 · 回合内自我审查 · 技能自我进化与技能管理器 · 四轨待办 · COI 调度 · 会话广 〔PR〕
...
- `[可用]` [bowenliang123-dsh-context](https://github.com/bowenliang123/dsh-context) 1408 — —
...
- `[待定]` [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) 195 — Data Agent for DeepSeek Harness: session-scoped database connections with a dedicated agent preset that lets A
...
- `[可用]` [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) 144 — Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authoriz
...
- `[可用]` [dsh-auto-memory](https://github.com/Aik358/dsh-auto-memory) 70 — DSH 自动记忆插件:三层记忆(用户级/项目笔记/每日日志)自动注入与检索、每日反思、可视化面板与设置页,支持继承其他 AI 工具的历史记忆
...
- `[可用]` [dsh-godot-skill](https://github.com/akira399/dsh-godot-skill) 24 — Godot Engine 4.x 全栈游戏开发技能插件 for DeepSeek Harness (DSH) — registers the godot-4-development skill at runtime
...
- `[可用]` [dsh-plugin-langfuse](https://github.com/linyp/dsh-plugin-langfuse) 13 — Langfuse observability for DeepSeek Harness (dsh): exports agent sessions as OpenTelemetry trace trees (GenAI
...
- `[可用]` [dsh-lark](https://github.com/omdsh-dev/dsh-lark) 54 — Lark/Feishu IM bot channel for DeepSeek Harness \| 飞书 DeepSeek Harness 插件
...
- `[待定]` [dsh-lark-link](https://github.com/amlyczz/dsh-lark-link) 39 — High-reliability Feishu/Lark bridge for DeepSeek Harness — QR one-click auth, multi-mode agents, card-based co
...
- `[未测]` [dsh-expression](https://github.com/yyh-001/dsh-expression) 87 — 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道
...
- `[可用]` [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) 67 — 在 DeepSeek Harness 中使用 ChatGPT/Codex 订阅，支持 OAuth 登录、额度与重置时间 \| ChatGPT/Codex subs
...
- `[可用]` [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) 172 — OpenPencil design preview and editing plugin for DSH
...
- `[可用]` [dsh-web-search-pro](https://github.com/anweat/dsh-web-search-pro) 65 — Enhanced, persistent web search plugin for DeepSeek Harness (multi-engine search, SQLite+LRU cache, platform b
- `[可用]` [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) 24 — 为 DSH Web UI 增加跨平台文件拖拽与原始路径插入能力，无需复制文件
- `[未测]` [dsh-recommend](https://github.com/zp-home/dsh-recommend) 20 — DSH 插件生态透明排行与推荐：每日自动抓取 dsh-plugin 话题 + 公开评分模型 + 排行/推荐插件与静态站
...
- `[不兼容]` [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) 75 — OpenMAIC for DeepSeek Harness: classrooms, slides, interactive widgets, and Socratic teaching
...
- `[可用]` [dsh-plugin-miliastra-toolbox](https://github.com/1475505/dsh-plugin-miliastra-toolbox) 9 — 将千星沙箱（原神千星奇域）知识库接入 Deepseek Harness 的插件
...
- `[可用]` [crafter-station-petdex](https://github.com/crafter-station/petdex) 4114 — —
- `[待定]` [small-tailqwq-dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) 2101 — —
- `[可用]` [whale-girl](https://github.com/vlln/whale-girl) 323 — DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴
- `[不兼容]` [pc2005-cloud-dsh-pet](https://github.com/PC2005-cloud/dsh-pet) 649 — —
...
- `[可用]` [dsh-memento](https://github.com/PerryLink/dsh-memento) 96 — Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.me
...
- `[不兼容]` [anywhere-labs-deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) 27053 — —
- `[不兼容]` [dataelement-dsh-desktop](https://github.com/dataelement/dsh-desktop) 6947 — —
- `[可用]` [hairyf-deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) 2164 — —
- `[可用]` [sepinetam-mcp-for-stata](https://github.com/SepineTam/mcp-for-stata) 258 — —
- `[不兼容]` [lum1104-dsh-browser](https://github.com/Lum1104/dsh-browser) 668 — —
- `[未测]` [Bigfish](https://github.com/turtle2209/Bigfish) 313 — Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带桌面萌宠
- `[待定]` [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) 167 — DSH桌面端，支持主题和背景图等多种个性化配置
- `[不兼容]` [ningbainb-deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) 580 — —
...
- `[不兼容]` [kelai141-dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) 457 — —
- `[不兼容]` [bruc3van-dsh-desktop](https://github.com/bruc3van/dsh-desktop) 91 — —
...
- `[可用]` [flymysql-dsh-remote](https://github.com/flymysql/dsh-remote) 82 — —
- `[不兼容]` [dsh-mobile](https://github.com/lehhair/dsh-mobile) 25 — —
- `[可用]` [liguobao-dsh-desktop](https://github.com/liguobao/dsh-desktop) 38 — —
- `[可用]` [runzhliu-deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) 84 — —
...
- `[待定]` [sorsama-deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) 81 — —
...
- `[不兼容]` [longyu065-dsh-desktop](https://github.com/longyu065/dsh-desktop) 2 — —
...
- `[可用]` [upstream-radar](https://github.com/MicroMilo/upstream-radar) 13 — Always-on vulnerability and breaking-change impact monitoring for DeepSeek Harness plugins.
...
- `[不兼容]` [michengai-deepseek-harness-desktop](https://github.com/MichengAI/deepseek-harness-desktop) 81 — —
...
- `[可用]` [deepseek-ai-deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 226582 — —
- `[可用]` [devin-axis-ipollowork](https://github.com/Devin-AXIS/iPolloWork) 6195 — —
- `[不兼容]` [awesome-dsh-plugin-awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) 15965 — —
- `[不兼容]` [imsai-sh-zhuzhiliao](https://github.com/imsai-sh/zhuzhiliao) 2880 — —
- `[可用]` [adamplatin123-awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) 1470 — —
- `[可用]` [PicGo-Core](https://github.com/PicGo/PicGo-Core) 987 — :zap:The ultimate image uploading engine
- `[不兼容]` [0xsline-awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) 1070 — —
- `[可用]` [mnemon-dev-mnemon](https://github.com/mnemon-dev/mnemon) 584 — —
- `[不兼容]` [electricitysheep-dsh-handbook](https://github.com/Electricitysheep/dsh-handbook) 785 — —
- `[可用]` [morluto-rea](https://github.com/morluto/rea) 409 — —
- `[可用]` [bruc3van-awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) 343 — —
...
- `[不兼容]` [ariestar-sivtr](https://github.com/Ariestar/sivtr) 272 — —
...
- `[可用]` [modsearch](https://github.com/liustack/modsearch) 492 — The web plugin for DeepSeek Harness, and the search bridge for every model without native web access
- `[可用]` [sikao-engine-kimix](https://github.com/Sikao-Engine/KimiX) 111 — —
- `[不兼容]` [hikariming-dshfind](https://github.com/hikariming/dshfind) 261 — —
- `[不兼容]` [pulseaiclub-phi](https://github.com/pulseaiclub/phi) 407 — —
- `[可用]` [libukai-awesome-deepseek-harness](https://github.com/libukai/awesome-deepseek-harness) 265 — —
- `[不兼容]` [dominic789654-awesome-deepseek-harness](https://github.com/Dominic789654/awesome-deepseek-harness) 339 — —
...
- `[可用]` [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) 418 — AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH)
...
- `[可用]` [morluto-jacobian](https://github.com/morluto/jacobian) 190 — —
- `[不兼容]` [beancookie-awesome-dsh-plugin](https://github.com/beancookie/awesome-dsh-plugin) 145 — —
- `[可用]` [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) 306 — DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步
...
- `[可用]` [dsh-computer-use](https://github.com/Anionex/dsh-computer-use) 45 — 为 DeepSeek Harness 提供电脑控制插件：新鲜 Accessibility 观测、过期状态拒绝、作用域权限与安全输入（目前支持macos）｜Accessibility-first macOS Compute
...
- `[可用]` [dqsjqian-aria](https://github.com/dqsjqian/Aria) 89 — —
...
- `[可用]` [modusensus-dsh-mneme](https://github.com/modusensus/dsh-mneme) 108 — —
...
- `[可用]` [imsai-sh-awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) 238 — —
...
- `[可用]` [ch4acko3-dsh-harmony](https://github.com/CH4ACKO3/dsh-harmony) 16 — —
...
- `[可用]` [railgun0325-dsh-phone](https://github.com/railgun0325/dsh-phone) 20 — —
...
- `[可用]` [dsh-agy](https://github.com/chaos-03x/dsh-agy) 40 — Google Antigravity (agy) OAuth auth + model access plugin for DeepSeek Harness: multi-account pool, 429 rotati
...
- `[可用]` [pi2dsh](https://github.com/weijiafu14/pi2dsh) 194 — Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plu
...
- `[可用]` [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) 57 — dsh-passwords: DeepSeek Harness login gateway - first-run setup, at-rest encryption, brute-force lockout, audi
...
- `[待定]` [dsh-crosstalk](https://github.com/Jesse-njx/dsh-crosstalk) 4 — Cross-session messaging for DSH — any session on the machine can list and messag
...
- `[可用]` [perrylink-dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) 33 — —
