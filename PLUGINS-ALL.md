...
- `[不兼容]` [dsh-tui-dsh-tui](https://github.com/dsh-tui/dsh-tui) 33 — —
...
- `[未测]` [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) 24 — —
...
- `[可用]` [dsh-pub-dsh-pub](https://github.com/dsh-pub/dsh-pub) 5 — —
...
- `[可用]` [dsh-soul-md](https://github.com/Scorp1o117/dsh-soul-md) 8 — Soul.md persona for DeepSeek Harness \| DeepSeek Harness 人设卡插件
