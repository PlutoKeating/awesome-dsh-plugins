...
- `[不兼容]` [distill](https://github.com/LoserFox/distill) 26 — 自动对话蒸馏：后台 subagent 反省 + 技能 create/update 〔PR〕
...
- `[可用]` [dsh-claude-compat](https://github.com/biedongbin/dsh-claude-compat) 12 — DSH plugin: bridge Claude Code's .claude/ directory (skills, commands, rules) into DeepSeek Harness natively
- `[可用]` [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) 22 — DeepSeek Harness (dsh) plugin: migrate Claude Code sessions, memory, skills and CLAUDE.md into DSH with seamle
...
- `[可用]` [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) 374 — Cross-agent, local-first persistent memory plugin for DeepSeek Harness (DSH), powered by Mnemon
...
- `[待定]` [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) 156 — DSH plugin: snapshot & rollback your plugin/skin/settings configs
...
- `[可用]` [dsh-market-dsh-market](https://github.com/dsh-market/dsh-market) 3973 — —
...
- `[可用]` [dsh-market](https://github.com/2BingLing/dsh-market) 110 — DeepSeek Harness 插件市场 · 持续收录 1000+ DSH 插件：中文搜索 + 实用五维评分 + 一键安装
...
- `[可用]` [dsh-mcp-manager](https://github.com/hyqhyq3/dsh-mcp-manager) 15 — MCP server manager plugin for DeepSeek Harness: Settings → MCP page, OAuth (PKCE + dynamic client registration
...
- `[可用]` [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) 3615 — 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面
- `[可用]` [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) 3050 — 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插件——像素鲸鱼顶栏、实时工作状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表
- `[可用]` [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) 626 — 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups for the DSH Web UI
- `[可用]` [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) 318 — 一站式 DeepSeek Harness 社区发行版：TUI、桌面端与 Web UI 三种形态统一体验，支持分层安装、一步到位，免去手工整合打包
...
- `[可用]` [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) 262 — 在 DSH 对话中生成交互式可视化｜Render model-generated interactive cards inside DSH conversations
- `[可用]` [dsh-genui](https://github.com/omdsh-dev/dsh-genui) 458 — GenUI for DeepSeek Harness: interactive UI components rendered inline in assistant replies via the dsh-ui fenc
- `[可用]` [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) 1104 — Eyes for text-only DeepSeek Harness agents: built-in free vision chain (no key) + pixel-level vision tools (Q&
...
- `[可用]` [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) 119 — DSH Web 选中批注插件：选文字→批注→回车随消息发送；气泡隐藏批注块（零闪烁）；回复按 Annotation N 逐条对照（可悬浮芯片）
- `[不兼容]` [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) 130 — DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add（Web界面的skill管理工具）
...
- `[待定]` [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) 96 — DSH Web UI plugin: auto-sends 「继续」 to resume requests interrupted by network errors or other non-human causes
...
- `[可用]` [dsh-theme-plugin](https://github.com/nevertoday/dsh-theme-plugin) 23 — —
...
- `[可用]` [dsh-plugin-better-sidebar-plugin-office](https://github.com/HuanLinOTO/dsh-plugin-better-sidebar-plugin-office) 46 — 为 better-sidebar 提供 Office 三件套预览（.docx/.xlsx/.pptx），独立 bundle 瘦身主体 \| Provides Office-suite preview (.docx/.xls
...
- `[可用]` [dsh-mcp-panel](https://github.com/PerryLink/dsh-mcp-panel) 58 — Read-only runtime management panel for the official DeepSeek Harness MCP client: /mcp command + Settings MCP t
...
- `[可用]` [perrylink-dsh-plugin-guide](https://github.com/PerryLink/dsh-plugin-guide) 39 — —
...
- `[未测]` [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) 350 — Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth logi
...
- `[未测]` [TokenTracker](https://github.com/xiufengsun/TokenTracker) 1620 — Local-first AI token usage & cost tracker for 31 coding tools incl
...
- `[待定]` [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) 1666 — AgentTeams plugin for DeepSeek Harness
...
- `[待定]` [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) 125 — 把Claude Code的UltraCode模式带给DSH，把 DSH 的一次性多 Agent 调度，升级为可生成、可保存、可治理、可观察、可恢复的 Workflow 层
...
- `[可用]` [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) 164 — 从Claude Code、Codex、Reasonix等Agent工具导入迁移历史消息，并在DeepSeek Harness(DSH)中继续对话
- `[不兼容]` [hongfeiyucode-deepseek-harness-desktop](https://github.com/hongfeiyucode/deepseek-harness-desktop) 36 — —
- `[待定]` [dsh-find-plugin](https://github.com/awesome-dsh-plugin/dsh-find-plugin) 137 — Find DSH plugins inside the agent — live GitHub dsh-plugin topic search, star-ranked / 会话内搜索发现 DSH 插件
- `[可用]` [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) 261 — Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support
...
- `[不兼容]` [pivotstackintelligence-dsh-github](https://github.com/PivotStackIntelligence/dsh-github) 98 — —
- `[可用]` [dsh-file-review](https://github.com/left0ver/dsh-file-review) 41 — a dsh plugin - review  files that an agent just changed,you can see the diff
...
- `[不兼容]` [franksong2702-dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) 107 — —
...
- `[可用]` [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) 95 — Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides wh
...
- `[待定]` [deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) 148 — deepseek-harness for vscode .This is a community project, and we welcome your valuable feedback!
...
- `[待定]` [DeepSeek-Harness-for-VS-Code](https://github.com/NEXTINDIE/DeepSeek-Harness-for-VS-Code) 9 — Use DeepSeek Harness in VS Code like ChatGPT/Copilot: @dsh in native chat, standalone views, cross-project ses
...
- `[可用]` [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) 169 — Second-model AI auto-review for DeepSeek Harness approval requests: a read-only
- `[待定]` [dsh-permission-rules](https://github.com/PerryLink/dsh-permission-rules) 112 — Claude Code-style declarative permission rules for DeepSeek Harness: ordered allow/deny/ask rules with tool-na
...
- `[可用]` [dsh-github](https://github.com/PerryLink/dsh-github) 10 — GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write
...
- `[未测]` [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) 24 — Deepseek Harness for VS Code
...
- `[未测]` [dsh-output-styles](https://github.com/PerryLink/dsh-output-styles) 6 — Claude Code outputStyles for DeepSeek Harness - session-scoped, durable, runtime-switchable model output style
...
- `[未测]` [dsh-prime-agent](https://github.com/yoke233/dsh-prime-agent) 5 — Prime Agent-inspired persistent RLM control plane for DeepSeek Harness Code Mode
...
- `[可用]` [dsh-qwen-mm](https://github.com/RRRosmontis/dsh-qwen-mm) 1 — Qwen-MM-Plugins integration bundle for DeepSeek Harness (dsh) — multimodal MCP tools (vision, OCR, ASR, search
...
- `[可用]` [foryourhealth111-pixel-vibe-skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) 3302 — —
- `[可用]` [modlens](https://github.com/liustack/modlens) 3968 — The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent
- `[不兼容]` [anionex-agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) 1208 — —
- `[可用]` [hellowind777-helloagents](https://github.com/hellowind777/helloagents) 705 — —
- `[可用]` [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) 647 — Open-source CMA-compatible agent runtime for any model, with MCP tools, sandboxed sessions, audit, replay, and
...
- `[不兼容]` [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) 376 — Open-source alternative to Claude Cowork — a local-first AI agent desktop app · multi-model · self-evolving sk
- `[可用]` [linhay-harmony-next-skills](https://github.com/linhay/harmony-next.skills) 348 — —
- `[不兼容]` [openma-ai-open-managed-agents](https://github.com/openma-ai/open-managed-agents) 280 — —
- `[可用]` [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) 308 — 为 DeepSeek Harness 带来「跨会话长期记忆 + 后台自我进化」能力的纯插件实现：五轨记忆 · git 分支感知 · 回合内自我审查 · 技能自我进化与技能管理器 · 四轨待办 · COI 调度 · 会话广 〔PR〕
...
- `[可用]` [bowenliang123-dsh-context](https://github.com/bowenliang123/dsh-context) 1393 — —
...
- `[待定]` [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) 161 — —
- `[不兼容]` [atlascloudai-atlas-cloud-skills](https://github.com/AtlasCloudAI/atlas-cloud-skills) 30 — —
- `[可用]` [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) 141 — Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authoriz
...
- `[可用]` [dsh-auto-memory](https://github.com/Aik358/dsh-auto-memory) 69 — DSH 自动记忆插件:三层记忆(用户级/项目笔记/每日日志)自动注入与检索、每日反思、可视化面板与设置页,支持继承其他 AI 工具的历史记忆
...
- `[待定]` [project-blueprint](https://github.com/shuguang1994/project-blueprint) 21 — Make any project AI-agent-ready in one command
...
- `[可用]` [omdsh-dev-dsh-plugin-skills](https://github.com/omdsh-dev/dsh-plugin-skills) 12 — —
...
- `[可用]` [dsh-session-notification](https://github.com/dingyi222666/dsh-session-notification) 22 — 提供会话完成等四种状态的通知响应，支持浏览器提示和提示词
- `[不兼容]` [dsh-plugin-yet-another-subagent](https://github.com/HuanLinOTO/dsh-plugin-yet-another-subagent) 17 — 可配置子代理 profile 系统，单一 subagent 工具 + profile 参数，含 Web UI 设置/实时进度/子代理树 \| Configurable subagent profile system: si
...
- `[待定]` [dsh-science-workbench](https://github.com/poplarity/dsh-science-workbench) 9 — A reproducible science workbench plugin for the DeepSeek Harness: agent-driven cells, inline figures with feed
...
- `[可用]` [dsh-media-skills](https://github.com/akqwpeter-prog/dsh-media-skills) 18 — —
...
- `[可用]` [dsh-session-pin](https://github.com/PerryLink/dsh-session-pin) 8 — Pin sessions in the DeepSeek Harness (DSH) web sidebar - dual-face plugin with a hover pin badge, durable pinn
...
- `[待定]` [DeepSeek-harness-wecom](https://github.com/sliverp/DeepSeek-harness-wecom) 4 — WeCom AI Bot text and image bridge for DeepSeek Harness
...
- `[可用]` [dsh-notify-windows](https://github.com/SeverusZh/dsh-notify-windows) 8 — —
...
- `[未测]` [dsh-expression](https://github.com/yyh-001/dsh-expression) 85 — 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道
...
- `[可用]` [dsh-plugin-notify](https://github.com/c-ling/dsh-plugin-notify) 7 — DeepSeek Harness 消息提醒插件：回合结束或等待确认时向浏览器、系统、飞书/钉钉/企业微信/通用 Webhook 发送通知
...
- `[可用]` [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) 173 — OpenPencil design preview and editing plugin for DSH
...
- `[可用]` [dsh-navbar](https://github.com/vlln/dsh-navbar) 53 — DSH 插件：对话节点导航条（右缘节点串快速跳转 user 消息）
...
- `[不兼容]` [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) 73 — OpenMAIC for DeepSeek Harness: classrooms, slides, interactive widgets, and Socratic teaching
...
- `[可用]` [crafter-station-petdex](https://github.com/crafter-station/petdex) 4105 — —
- `[待定]` [small-tailqwq-dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) 2085 — —
- `[可用]` [whale-girl](https://github.com/vlln/whale-girl) 323 — DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴
- `[不兼容]` [pc2005-cloud-dsh-pet](https://github.com/PC2005-cloud/dsh-pet) 640 — —
...
- `[可用]` [dsh-memento](https://github.com/PerryLink/dsh-memento) 95 — Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.me
...
- `[不兼容]` [anywhere-labs-deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) 26790 — —
- `[不兼容]` [dataelement-dsh-desktop](https://github.com/dataelement/dsh-desktop) 6674 — —
- `[可用]` [hairyf-deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) 2119 — —
- `[可用]` [sepinetam-mcp-for-stata](https://github.com/SepineTam/mcp-for-stata) 258 — —
- `[不兼容]` [lum1104-dsh-browser](https://github.com/Lum1104/dsh-browser) 663 — —
...
- `[不兼容]` [ningbainb-deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) 561 — —
...
- `[不兼容]` [kelai141-dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) 442 — —
- `[不兼容]` [bruc3van-dsh-desktop](https://github.com/bruc3van/dsh-desktop) 88 — —
- `[可用]` [hanelalo-browser-bridge](https://github.com/hanelalo/browser-bridge) 51 — —
...
- `[不兼容]` [ego-browser](https://github.com/Fisfzy/ego-browser) 171 — DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、
- `[可用]` [cc1252-deepseek-harness-desktop](https://github.com/cc1252/deepseek-harness-desktop) 19 — —
- `[可用]` [flymysql-dsh-remote](https://github.com/flymysql/dsh-remote) 79 — —
...
- `[待定]` [sorsama-deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) 78 — —
...
- `[可用]` [ankocd-dsh-server-deployment](https://github.com/AnkoCD/dsh-server-deployment) 32 — —
...
- `[不兼容]` [onenightcarnival-deepseek-harness-desktop](https://github.com/Onenightcarnival/deepseek-harness-desktop) 4 — —
...
- `[可用]` [alaliqing-claude-paper](https://github.com/alaliqing/claude-paper) 337 — —
- `[不兼容]` [dsh-deep-research](https://github.com/omdsh-dev/dsh-deep-research) 24 — Adaptive deep-research orchestrator plugin for DeepSeek Harness (official workflow engine, cybernetics/informa
...
- `[可用]` [deepseek-ai-deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 225307 — —
- `[可用]` [devin-axis-ipollowork](https://github.com/Devin-AXIS/iPolloWork) 6126 — —
- `[不兼容]` [awesome-dsh-plugin-awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) 15822 — —
...
- `[可用]` [PicGo-Core](https://github.com/PicGo/PicGo-Core) 986 — :zap:The ultimate image uploading engine
- `[不兼容]` [0xsline-awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) 1065 — —
- `[可用]` [mnemon-dev-mnemon](https://github.com/mnemon-dev/mnemon) 581 — —
- `[不兼容]` [electricitysheep-dsh-handbook](https://github.com/Electricitysheep/dsh-handbook) 785 — —
- `[可用]` [morluto-rea](https://github.com/morluto/rea) 408 — —
- `[可用]` [bruc3van-awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) 338 — —
...
- `[不兼容]` [ariestar-sivtr](https://github.com/Ariestar/sivtr) 273 — —
- `[不兼容]` [ruler4396-dsh-launcher](https://github.com/Ruler4396/dsh-launcher) 207 — —
...
- `[可用]` [modsearch](https://github.com/liustack/modsearch) 485 — The web plugin for DeepSeek Harness, and the search bridge for every model without native web access
- `[可用]` [sikao-engine-kimix](https://github.com/Sikao-Engine/KimiX) 111 — —
- `[不兼容]` [hikariming-dshfind](https://github.com/hikariming/dshfind) 259 — —
- `[不兼容]` [pulseaiclub-phi](https://github.com/pulseaiclub/phi) 397 — —
- `[可用]` [libukai-awesome-deepseek-harness](https://github.com/libukai/awesome-deepseek-harness) 264 — —
- `[不兼容]` [dominic789654-awesome-deepseek-harness](https://github.com/Dominic789654/awesome-deepseek-harness) 324 — —
- `[未测]` [deep-flow](https://github.com/zimenglan-sysu-512/deep-flow) 71 — —
- `[不兼容]` [alex-yanggg-awesome-dsh-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) 97 — —
...
- `[可用]` [ayase34-gal-view](https://github.com/Ayase34/gal-view) 173 — —
- `[可用]` [pingfanfan-hello-dsh](https://github.com/pingfanfan/hello-dsh) 96 — —
- `[可用]` [lyn-77-promentor](https://github.com/Lyn-77/ProMentor) 74 — —
- `[可用]` [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) 416 — AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH)
...
- `[可用]` [morluto-jacobian](https://github.com/morluto/jacobian) 189 — —
- `[不兼容]` [beancookie-awesome-dsh-plugin](https://github.com/beancookie/awesome-dsh-plugin) 143 — —
- `[可用]` [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) 302 — DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步
...
- `[可用]` [noob-stupid-dsh-plugin-hub](https://github.com/Noob-stupid/dsh-plugin-hub) 86 — —
...
- `[可用]` [dsh-computer-use](https://github.com/Anionex/dsh-computer-use) 43 — 为 DeepSeek Harness 提供电脑控制插件：新鲜 Accessibility 观测、过期状态拒绝、作用域权限与安全输入（目前支持macos）｜Accessibility-first macOS Compute
...
- `[可用]` [blender](https://github.com/CheshireJCat/blender) 29 — DeepSeek Harness plugin for complete Blender 3D modeling, reconstruction, rendering, validation, and export wo
- `[可用]` [dqsjqian-aria](https://github.com/dqsjqian/Aria) 87 — —
...
- `[可用]` [modusensus-dsh-mneme](https://github.com/modusensus/dsh-mneme) 104 — —
...
- `[可用]` [imsai-sh-awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) 236 — —
- `[可用]` [linenxi-ctrl-dsh-vision](https://github.com/linenxi-ctrl/dsh-vision) 10 — —
...
- `[不兼容]` [bin-hy-dsh](https://github.com/Bin-hy/dsh) 19 — —
...
- `[可用]` [pi2dsh](https://github.com/weijiafu14/pi2dsh) 191 — Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plu
...
- `[可用]` [dsh-compaction-instant](https://github.com/KitDoesIt/dsh-compaction-instant) 15 — LLM-free lossless* compaction engine for DeepSeek Harness
...
- `[可用]` [deepseek-harness-acp](https://github.com/openma-ai/deepseek-harness-acp) 30 — ACP server implementation for DeepSeek harness
...
- `[可用]` [compforge-baton](https://github.com/compforge/baton) 7 — —
...
- `[待定]` [dsh-openapi](https://github.com/Degurechaff57/dsh-openapi) 3 — Safe OpenAPI 3.x discovery and API calling tools for DeepSeek Harness
...
- `[不兼容]` [dsh-mc-launcher](https://github.com/hellosky983/dsh-mc-launcher) 10 — Minecraft launcher built on DeepSeek Harness: full-screen launcher UI (root slot) with version download, Micro
...
- `[可用]` [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) 56 — dsh-passwords: DeepSeek Harness login gateway - first-run setup, at-rest encryption, brute-force lockout, audi
...
- `[可用]` [freehul-sgme](https://github.com/freehul/sgme) 13 — —
...
- `[可用]` [perrylink-dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) 31 — —
...
- `[可用]` [dsh-specflow](https://github.com/lonelymoon87/dsh-specflow) 4 — —
