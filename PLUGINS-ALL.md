...
- `[可用]` [forkprobe](https://github.com/Jayden-X-L/forkprobe) 72 — Compare multiple skills on the same task and pick the winner.
- `[不兼容]` [mstar-harness](https://github.com/btspoony/mstar-harness) 58 — A Skill-driven Harness/Loop Engineering Workflow Agent Plugin
...
- `[不兼容]` [distill](https://github.com/LoserFox/distill) 25 — 自动对话蒸馏：后台 subagent 反省 + 技能 create/update 〔PR〕
...
- `[可用]` [dsh-claude-compat](https://github.com/biedongbin/dsh-claude-compat) 11 — DSH plugin: bridge Claude Code's .claude/ directory (skills, commands, rules) into DeepSeek Harness natively
- `[可用]` [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) 20 — DeepSeek Harness (dsh) plugin: migrate Claude Code sessions, memory, skills and CLAUDE.md into DSH with seamle
...
- `[可用]` [dsh-plugin-longgraph](https://github.com/levi-qiao/dsh-plugin-longgraph) 4 — DeepSeek Harness community plugin: longgraph / loop-graph / loop-converge authoring skills on ctx.skills
...
- `[可用]` [dsh-data-ledger](https://github.com/Niuniu-Sir/dsh-data-ledger) 1 — 数据台账：DeepSeek Harness 本地数据统一看板——对话/账本/技能/记忆/日志的来源、位置与内容摘要，回收站删除、浏览器存储清理（dsh-plugin）
- `[可用]` [dsh-wanghong-handwritten-ppt](https://github.com/tjxj/dsh-wanghong-handwritten-ppt) 4 — 王虹学术手写风 PPT Skill for DeepSeek Harness · Notability-style HTML slides and PNG ex

## 🧠 记忆增强（20）

- `[可用]` [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) 365 — Cross-agent, local-first persistent memory plugin for DeepSeek Harness (DSH), powered by Mnemon
...
- `[不兼容]` [dsh-ops-kit](https://github.com/LeslieWylie/dsh-ops-kit) 2 — A reusable DeepSeek Harness bundle for evidence-driven memory, orchestration, benchmark operations, and plugin
- `[不兼容]` [mongfayi-dsh-recall](https://github.com/Mongfayi/dsh-recall) 2 — —
- `[可用]` [dsh-plugin-jinji](https://github.com/quan2005/dsh-plugin-jinji) 1 — 把「记忆」带进 DeepSeek Harness：极简文本记忆系统，双轨记忆（流水日志 + 人物/产品实体画像），大模型为核心驱动
...
- `[可用]` [dsh-claude-mem](https://github.com/Bleed00/dsh-claude-mem) 1 — DeepSeek Harness plugin integrating claude-mem (memory for dsh)
- `[可用]` [dsh-plugin-sysmon](https://github.com/hnmrxz/dsh-plugin-sysmon) 1 — Local system resource monitor (CPU / memory / disk / load / uptime) for the DeepSeek Harness bottom status bar
- `[待定]` [dsh-pin-recall](https://github.com/kerwin2046/dsh-pin-recall) 1 — DeepSeek Harness plugin: pin assistant replies and recall them into the model turn
- `[不兼容]` [dsh-plugin-device-info](https://github.com/lsz-asd/dsh-plugin-device-info) 1 — Read-only Windows device info tools for DeepSeek Harness: 12 win_* tools (time, system, CPU, memory, disk, GPU
- `[可用]` [deepseek-harness-evolver](https://github.com/shinjiyu/deepseek-harness-evolver) 0 — Complement to DSH Creator mode: stage, score, and solidify in-memory plugin trials to disk.
...
- `[待定]` [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) 153 — DSH plugin: snapshot & rollback your plugin/skin/settings configs
...
- `[未测]` [dsh-catnap-studio](https://github.com/luoyan96/dsh-catnap-studio) 2 — DeepSeek Harness Web UI 的三合一猫咪主题皮肤插件，内置暖纸猫窝、月夜守护与猫咪工坊
...
- `[可用]` [dsh-market-dsh-market](https://github.com/dsh-market/dsh-market) 3756 — —
- `[不兼容]` [zat-dsh-engine](https://github.com/mishibeikejie/zat-dsh-engine) 80 — Visual plugin marketplace for DeepSeek Harness — browse, search and install community plugins
...
- `[可用]` [dsh-plugin-marketplace](https://github.com/AwesomeHou/dsh-plugin-marketplace) 29 — Plugin marketplace for DeepSeek Harness — live-syncs the GitHub dsh-plugin topic (1800+ repos) into a searchab
- `[可用]` [dsh-market](https://github.com/2BingLing/dsh-market) 108 — DeepSeek Harness 插件市场 · 持续收录 1000+ DSH 插件：中文搜索 + 实用五维评分 + 一键安装
- `[可用]` [ericwong5021-deepseek-plugin-store](https://github.com/Ericwong5021/deepseek-plugin-store) 25 — —
- `[不兼容]` [dsh-melody-launcher](https://github.com/rirko/dsh-melody-launcher) 26 — dsh-旋律启动器：DeepSeek Harness 桌面启动器与插件管理器
- `[可用]` [dsh-plugin-healthcheck](https://github.com/chenw2759-wq/dsh-plugin-healthcheck) 16 — 害怕插件装了就崩溃？用这个插件帮你检测插件是否正常/是否含木马！
...
- `[可用]` [chnjames-dsh-plugin-market](https://github.com/chnjames/dsh-plugin-market) 5 — —
...
- `[待定]` [dsh-dynplugin-manager](https://github.com/Thomas-key/dsh-dynplugin-manager) 1 — Manage DeepSeek Harness dynamic plugins: scan local directories, browse, and load with /dyn slash commands
...
- `[可用]` [dsh-plugin-manager](https://github.com/Jesse-njx/dsh-plugin-manager) 0 — dsh pm — discover, install, update, and manage dsh plugins from the CLI: multi-s
...
- `[可用]` [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) 3547 — 一个侧边栏的完整工作台，支持三方拓展注册新侧边栏页面
- `[可用]` [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) 2987 — 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插件——像素鲸鱼顶栏、实时工作状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表
- `[可用]` [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) 619 — 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups for the DSH Web UI
- `[可用]` [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) 312 — 一站式 DeepSeek Harness 社区发行版：TUI、桌面端与 Web UI 三种形态统一体验，支持分层安装、一步到位，免去手工整合打包
- `[待定]` [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) 274 — dsh-tianshu-tui — DeepSeek Harness terminal UI +harness workflow
- `[可用]` [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) 259 — 在 DSH 对话中生成交互式可视化｜Render model-generated interactive cards inside DSH conversations
- `[可用]` [dsh-genui](https://github.com/omdsh-dev/dsh-genui) 440 — GenUI for DeepSeek Harness: interactive UI components rendered inline in assistant replies via the dsh-ui fenc
- `[可用]` [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) 1102 — Eyes for text-only DeepSeek Harness agents: built-in free vision chain (no key) + pixel-level vision tools (Q&
...
- `[可用]` [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) 114 — DSH Web 选中批注插件：选文字→批注→回车随消息发送；气泡隐藏批注块（零闪烁）；回复按 Annotation N 逐条对照（可悬浮芯片）
- `[不兼容]` [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) 124 — DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add（Web界面的skill管理工具）
- `[不兼容]` [heigeai-deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) 53 — —
- `[不兼容]` [ui-status-label](https://github.com/alingalingling/ui-status-label) 44 — 把你鲸鱼娘思考时的 deep diving 自定义成任意你想要的样子
...
- `[可用]` [dsh-ui-whale](https://github.com/lhh010/dsh-ui-whale) 32 — 【求⭐】🐋DSH Web UI 全手绘像素鲸鱼伙伴插件：会话标题栏常驻，平时眨眼/偶尔摆尾/动胸鳍，思考运行时持续动起来，回合完成头顶喷水，点击还会冒爱心，不工作时还会偷懒睡觉，零核心改动 〔PR〕
- `[不兼容]` [openma-ai-deepseek-harness-tui](https://github.com/openma-ai/deepseek-harness-tui) 71 — —
- `[不兼容]` [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) 59 — OpenBiliClaw 是本地运行的跨平台个性化内容推荐 Agent，持续理解你的兴趣并主动找内容
- `[可用]` [147228-dsh-xiaoyao-skins](https://github.com/147228/dsh-xiaoyao-skins) 24 — —
- `[待定]` [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) 92 — DSH Web UI plugin: auto-sends 「继续」 to resume requests interrupted by network errors or other non-human causes
...
- `[可用]` [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) 27 — 为 DSH 增加桌面通知提醒
- `[可用]` [iuikj-dsh-desktop](https://github.com/iuikj/dsh-desktop) 19 — —
...
- `[可用]` [dsh-theme-plugin](https://github.com/nevertoday/dsh-theme-plugin) 24 — —
- `[不兼容]` [dsh-tui-dsh-tui](https://github.com/dsh-tui/dsh-tui) 31 — —
- `[待定]` [dsh-file-explorer](https://github.com/joejojoking-cloud/dsh-file-explorer) 22 — File explorer plugin for DeepSeek Harness: file tree, preview, markdown, syntax highlighting, in-panel editing
...
- `[待定]` [freestyle-dsh-theme](https://github.com/suzike/freestyle-dsh-theme) 12 — DeepSeek Harness 主题体验插件：OKLCH 主题提案 + 主题设计器（跨重启持久化）
...
- `[可用]` [dsh-plugin-better-sidebar-plugin-office](https://github.com/HuanLinOTO/dsh-plugin-better-sidebar-plugin-office) 44 — 为 better-sidebar 提供 Office 三件套预览（.docx/.xlsx/.pptx），独立 bundle 瘦身主体 \| Provides Office-suite preview (.docx/.xls
...
- `[可用]` [dsh-context-doctor](https://github.com/Zhenyu98/dsh-context-doctor) 29 — DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重复与冲突；Web UI 圆环面板 + context_audit 工具
...
- `[待定]` [dsh-ux](https://github.com/jiangnanquan/dsh-ux) 7 — DSH web UI 增强插件 + 无边框 Electron 桌面壳
...
- `[可用]` [dsh-mcp-panel](https://github.com/PerryLink/dsh-mcp-panel) 55 — Read-only runtime management panel for the official DeepSeek Harness MCP client: /mcp command + Settings MCP t
...
- `[可用]` [dsh-quota-panel](https://github.com/brittanistrehlowll-oss/dsh-quota-panel) 3 — Provider quota/balance corner panel for the dsh web surface (DeepSeek Harness plugin): server-side credential
- `[不兼容]` [danielou1208-deepseek-harness-tui](https://github.com/DanielOu1208/deepseek-harness-tui) 7 — —
- `[可用]` [dqsjqian-agent-guild](https://github.com/dqsjqian/agent-guild) 5 — —
...
- `[可用]` [widget-dock](https://github.com/MorGogh/widget-dock) 3 — DSH plugin: draggable widget panel (balance, tokens, stats, commands, goal, cost) for DeepSeek Harness
- `[可用]` [mytianyi0712-dsh-tui-plugin-ohmypi](https://github.com/mytianyi0712/dsh-tui-plugin-OhMyPi) 5 — —
...
- `[可用]` [dsh-meta-orchestrator](https://github.com/jiruidai/dsh-meta-orchestrator) 4 — A model-native meta-agent plugin for DeepSeek Harness that uses the underlying model’s reasoning and planning
...
- `[可用]` [perrylink-dsh-plugin-guide](https://github.com/PerryLink/dsh-plugin-guide) 38 — —
...
- `[未测]` [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) 338 — Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth logi
...
- `[不兼容]` [dsh-vision](https://github.com/237229953-create/dsh-vision) 2 — DSH plugin: text-only models (e.g 〔PR〕
...
- `[可用]` [little-greenbean-dsh-tui](https://github.com/little-greenbean/dsh-tui) 1 — —
...
- `[可用]` [omdsh-dev-dsh-ui-progress](https://github.com/omdsh-dev/dsh-ui-progress) 1 — —
...
- `[可用]` [qiushui0901-deepseek-harness-desktop](https://github.com/qiushui0901/deepseek-harness-desktop) 1 — —
...
- `[可用]` [renat3u-tonghuashun-webui](https://github.com/renat3u/tonghuashun-webui) 21 — —
...
- `[不兼容]` [dsh-test-runner](https://github.com/suimi8/dsh-test-runner) 1 — DSH plugin: structured test runner tool (test_run) — auto-detect vitest/jest/pytest/node:test, run tests, pars
...
- `[可用]` [deepseek-harness-vscode](https://github.com/urwff/deepseek-harness-vscode) 1 — Run DeepSeek Harness in the VS Code sidebar, Claude Code for VS Code style
- `[不兼容]` [dsh-custom-css](https://github.com/AnacondaKC/dsh-custom-css) 2 — —
- `[不兼容]` [dsh-review-loop](https://github.com/wuxiangru915/dsh-review-loop) 1 — Incremental diff reviewer for DeepSeek Harness — Web UI review panel + /review c
...
- `[可用]` [ds-web-ui](https://github.com/xing-shuyin/ds-web-ui) 1 — My DeepSeek Harness Web UI
- `[可用]` [dsh-genshin-skin](https://github.com/bupianlizhugui/dsh-genshin-skin) 3 — 可以直接给deepseek harness换原神主题
- `[待定]` [dsh-theme-plugin](https://github.com/BeiZi6/dsh-theme-plugin) 5 — DSH Web GUI theme studio: presets + per-mode customization (accent, background, foreground, fonts, translucent
...
- `[待定]` [dsh-zotero](https://github.com/yuzh2001/dsh-zotero) 1 — 在 DeepSeek Harness 中浏览、搜索并引用你的 Zotero 文献库（侧边栏文件树 + & 与 /zotero 快速引用）
...
- `[可用]` [oceanxuikun-dsh-eva-theme-plugin](https://github.com/oceanxuikun/dsh-eva-theme-plugin) 3 — —
...
- `[不兼容]` [dsh-token-viewer](https://github.com/qwert702/dsh-token-viewer) 7 — DSH web GUI plugin: live token consumption surfaces (composer dock strip + sideb
...
- `[待定]` [dsh-Solarized](https://github.com/zhijun-dai/dsh-Solarized) 7 — Solarized + Selenized themes for DeepSeek Harness (dsh): four faithful palettes

## 💻 编码开发（253）

- `[未测]` [TokenTracker](https://github.com/xiufengsun/TokenTracker) 1593 — Local-first AI token usage & cost tracker for 31 coding tools incl
- `[不兼容]` [paean-ai-deeptide](https://github.com/paean-ai/deeptide) 1099 — —
- `[可用]` [nutshellai-tech-mobius](https://github.com/nutshellai-tech/mobius) 295 — —
- `[待定]` [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) 1589 — AgentTeams plugin for DeepSeek Harness
- `[不兼容]` [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) 510 — Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their conte
- `[可用]` [DSH-Plugins-Marketplace](https://github.com/bradeGithub/DSH-Plugins-Marketplace) 164 — DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub topic:dsh-plugin 的全部插件 \| brows
...
- `[不兼容]` [kuangre123-codex-switch](https://github.com/kuangre123/codex-switch) 68 — —
- `[待定]` [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) 121 — 把Claude Code的UltraCode模式带给DSH，把 DSH 的一次性多 Agent 调度，升级为可生成、可保存、可治理、可观察、可恢复的 Workflow 层
...
- `[可用]` [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) 156 — 从Claude Code、Codex、Reasonix等Agent工具导入迁移历史消息，并在DeepSeek Harness(DSH)中继续对话
- `[不兼容]` [hongfeiyucode-deepseek-harness-desktop](https://github.com/hongfeiyucode/deepseek-harness-desktop) 36 — —
- `[待定]` [dsh-find-plugin](https://github.com/awesome-dsh-plugin/dsh-find-plugin) 132 — Find DSH plugins inside the agent — live GitHub dsh-plugin topic search, star-ranked / 会话内搜索发现 DSH 插件
- `[可用]` [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) 214 — Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support
...
- `[不兼容]` [dsh-toolkit](https://github.com/omdsh-dev/dsh-toolkit) 29 — DSH 零依赖工具包 collection —— time / encoding / json / calculator / csv / regex / markdown / diff / stat / schema 十
...
- `[不兼容]` [pivotstackintelligence-dsh-github](https://github.com/PivotStackIntelligence/dsh-github) 105 — —
- `[可用]` [dsh-file-review](https://github.com/left0ver/dsh-file-review) 40 — a dsh plugin - review  files that an agent just changed,you can see the diff
...
- `[不兼容]` [canglongcl-dsh-web-review](https://github.com/CanglongCl/dsh-web-review) 19 — —
...
- `[可用]` [dsh-git-graph](https://github.com/1841220388zzzcccxxx-star/dsh-git-graph) 15 — Embedded git repository graph visualizer for the DeepSeek Harness Web GUI \| 嵌入式 Git 仓库图谱可视化插件（提交历史图 / 分支过滤 / 文
- `[不兼容]` [franksong2702-dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) 104 — —
- `[待定]` [dsh-provider-model-configurator](https://github.com/LiangYin233/dsh-provider-model-configurator) 19 — DSH 模型 Pro:为 DSH WebUI 提供将 pi-ai 预设或任意已配置提供商的模型上下文、输出上限、推理档位与兼容开关一键应用到目标提供商,并集中查看、新建、编辑、复制与删除各提供商模型条目的能力
- `[可用]` [dsh-advisor](https://github.com/omdsh-dev/dsh-advisor) 18 — Advisor - Pair a second model that passively reviews each turn and injects notes
- `[待定]` [dscode](https://github.com/creativedswork/dscode) 10 — dscode is a coding agent that empowers digital and knowledge work
- `[可用]` [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) 87 — Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides wh
- `[不兼容]` [icodesign-orbis](https://github.com/icodesign/orbis) 14 — —
- `[可用]` [dsh-bash-terminal](https://github.com/MAXeaglet/dsh-bash-terminal) 20 — —
...
- `[可用]` [dsh-llm-codebuddy](https://github.com/Axiaohungry/dsh-llm-codebuddy) 36 — 在deepseek harness中使用workbuddy api，因为公司只提供workbuddy积分
...
- `[不兼容]` [dsh-director-toolkit](https://github.com/lhmd/dsh-director-toolkit) 6 — DSH Director Toolkit is a DeepSeek Harness plugin for 3D artists, technical designers, and creative coders
...
- `[待定]` [dsh-sidechain](https://github.com/omdsh-dev/dsh-sidechain) 14 — DSH 侧会话插件：/side 持续性侧会话（Codex 风格）与 /btw 一次性侧问（Claude 风格）——在临时 fork 中运行、不写入主会话历史；Web UI 右侧链面板内嵌对话，主会话保持不变
- `[可用]` [dsh-plugin-diff-review](https://github.com/Civitasv/dsh-plugin-diff-review) 6 — Diff Review Plugin for DeepSeek Harness
- `[待定]` [task-passport](https://github.com/dongsheng123132/task-passport) 11 — Open task handoff protocol for DeepSeek Harness, WorkBuddy, Claude Code and Codex — verified state, not chat l
...
- `[可用]` [dsh-latex-tools](https://github.com/liuup/dsh-latex-tools) 11 — ♾️ Copy and export the LaTeX in DeepSeek Harness 悬停任意 LaTeX 公式即可复制 TeX 源码或导出为独立的 SVG 文件
...
- `[可用]` [deepseek-harness-vsc-extension](https://github.com/weinibuliu/deepseek-harness-vsc-extension) 22 — DeepSeek Harness for VS Code as extension
...
- `[待定]` [dsh-vsc-integration](https://github.com/HarcoChen/dsh-vsc-integration) 13 — Deepseek-Harness Vscode Integration
...
- `[可用]` [deepseek-harness-external-migration](https://github.com/buguoshixc/deepseek-harness-external-migration) 3 — **DeepSeek-Harness Migration Plugin** 是一款专为 [DeepSeek-Harness](https://github.com/deepseek-ai/deepseek-harness
...
- `[待定]` [DeepSeek-Harness-for-VS-Code](https://github.com/NEXTINDIE/DeepSeek-Harness-for-VS-Code) 8 — Use DeepSeek Harness in VS Code like ChatGPT/Copilot: @dsh in native chat, standalone views, cross-project ses
...
- `[可用]` [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) 162 — Second-model AI auto-review for DeepSeek Harness approval requests: a read-only
...
- `[未测]` [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) 19 — —
- `[未测]` [dsh-ssh](https://github.com/UynajGI/dsh-ssh) 11 — SSH remote-execution plugin for DeepSeek Harness: ProxyJump chain, SFTP filesystem, subprocess and PTY over ss
...
- `[可用]` [codeanqiang-ma-dsh-superpowers](https://github.com/codeAnqiang-ma/dsh-superpowers) 6 — —
...
- `[可用]` [inmny-dsh-git-bash](https://github.com/inmny/dsh-git-bash) 12 — —
...
- `[可用]` [dsh-github](https://github.com/PerryLink/dsh-github) 9 — GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write
...
- `[未测]` [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) 23 — Deepseek Harness for VS Code
- `[未测]` [dsh-checkpoint-rewind](https://github.com/PerryLink/dsh-checkpoint-rewind) 18 — Claude Code /rewind for DeepSeek Harness — git-first workspace snapshots before every mutation, turn-boundary
...
- `[未测]` [dsh-output-styles](https://github.com/PerryLink/dsh-output-styles) 5 — Claude Code outputStyles for DeepSeek Harness - session-scoped, durable, runtime-switchable model output style
...
- `[待定]` [dsh-session-tree](https://github.com/ZhengQingJing/dsh-session-tree) 2 — Git-like immutable session branching for DeepSeek Harness
- `[待定]` [deepseek-harness.dsh-agent-vscode](https://github.com/091635Aa/deepseek-harness.dsh-agent-vscode) 1 — deepseek-harness.dsh-agent-vscode
- `[可用]` [dsh-code-check](https://github.com/a179-sanae/dsh-code-check) 1 — —
- `[可用]` [dsh-file-mentions](https://github.com/a903067276-rgb/dsh-file-mentions) 11 — Clickable file paths in DSH replies: Codex-style inline open, 📂 reveal in file m
...
- `[可用]` [dsh-terminal](https://github.com/dongsheng123132/dsh-terminal) 1 — Persistent interactive terminal mode for DeepSeek Harness
- `[可用]` [dshx](https://github.com/dongsheng123132/dshx) 1 — Machine-friendly DeepSeek Harness adapter with cwd, stdin, timeout, stable JSON — CLI + Codex/Agent plugins
...
- `[可用]` [dsh-tiered-approval](https://github.com/Elaina-real/dsh-tiered-approval) 1 — Tiered auto-review for DeepSeek Harness: static-rule safety net + LLM reviewer +
...
- `[可用]` [kalynnka-vscode-deepseek-harness](https://github.com/kalynnka/vscode-deepseek-harness) 4 — —
...
- `[可用]` [dsh-project-mcp-bridge](https://github.com/KYinCode/dsh-project-mcp-bridge) 1 — Per-project MCP loading for DeepSeek Harness: drop a .dsh/mcp.json into a project and its sessions get the MCP
...
- `[不兼容]` [dsh-gitflow](https://github.com/lonelymoon87/dsh-gitflow) 1 — Git status, diff, commit, pull request, and worktree workflows for DeepSeek Harn
- `[可用]` [dsh-git-plugin](https://github.com/MashedPotato817/dsh-git-plugin) 1 — Git workflow plugin for DeepSeek Harness: slash commands and read-only git tools
...
- `[可用]` [shatyuka-dsh-llm-codebuddy](https://github.com/shatyuka/dsh-llm-codebuddy) 5 — —
...
- `[可用]` [dsh-failure-capsule](https://github.com/YiHarvest/dsh-failure-capsule) 6 — Local-first failure evidence capsules for DeepSeek Harness sessions
...
- `[未测]` [dsh-openai-codex-auth](https://github.com/yoke233/dsh-openai-codex-auth) 12 — OpenAI Codex OAuth login and usage card plugin for DeepSeek Harness
- `[未测]` [dsh-plugin-codex-bridge](https://github.com/YYTbit/dsh-plugin-codex-bridge) 1 — Bridge codex skills and config into DeepSeek Harness
...
- `[未测]` [dsh-tool-git](https://github.com/Huasfan/dsh-tool-git) 1 — Git tools for DeepSeek Harness agent
...
- `[不兼容]` [dsh-web-search-firecrawl](https://github.com/yangzhe1003/dsh-web-search-firecrawl) 1 — Firecrawl-backed search provider plugin for the DeepSeek Harness web capability seam (ctx.web)
...
- `[不兼容]` [localharness](https://github.com/qiyuequkanhaiba/localharness) 1 — Independent Electron shell for official DeepSeek Harness
...
- `[不兼容]` [dsh-cc-connect](https://github.com/whiteguo233/dsh-cc-connect) 4 — 通过cc connect远程使用dsh
- `[可用]` [dsh-trace](https://github.com/vibeinging/dsh-trace) 1 — DeepSeek Harness telemetry backend that exports turns, model steps, and tool cal
...
- `[可用]` [dsh-codex-oauth](https://github.com/Babulubobo/dsh-codex-oauth) 3 — use your codex subscription in deepseek harness
...
- `[可用]` [dsh-resume-plugin](https://github.com/Demogorgon314/dsh-resume-plugin) 0 — 让 DeepSeek Harness 安全读取并继续 Codex 与 Claude Code 的历史会话
...
- `[可用]` [dsh-plugin-codex-import](https://github.com/Gordonynh/dsh-plugin-codex-import) 0 — DeepSeek Harness plugin: import OpenAI Codex conversation history into DSH sessions via /codex-import \| 用 /cod
...
- `[待定]` [dsh-codex-bridge](https://github.com/pandashere/dsh-codex-bridge) 0 — Codex CLI bridge plugin for DeepSeek Harness with host tools and a Web conversat
- `[不兼容]` [dsh-kimi-bridge](https://github.com/pandashere/dsh-kimi-bridge) 0 — Kimi CLI bridge plugin for DeepSeek Harness with review-only mode and a Web conv
...
- `[可用]` [dsh-screenshot-diff](https://github.com/PangYiMing/dsh-screenshot-diff) 0 — DSH plugin: pixel-diff two screenshots into diff.png + triptych (pixelmatch) — 像
- `[不兼容]` [plutoczm-deepseek-harness-vscode](https://github.com/plutoczm/deepseek-harness-vscode) 0 — —
- `[不兼容]` [sakaliolabs-dsh-code-ide](https://github.com/SakalioLabs/dsh-code-ide) 10 — —
...
- `[可用]` [dsh-figma-to-lottie](https://github.com/zimai233/dsh-figma-to-lottie) 4 — Figma/SVG to Lottie animation compiler for DeepSeek Harness
...
- `[可用]` [dsh-plugin-deepseek-balance](https://github.com/fishxcode/dsh-plugin-deepseek-balance) 2 — DeepSeek Harness Web client plugin that displays real-time DeepSeek API balance.
...
- `[可用]` [dsh-gateway-provider](https://github.com/Luck9Star/dsh-gateway-provider) 3 — —
...
- `[可用]` [foryourhealth111-pixel-vibe-skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) 3261 — —
- `[可用]` [modlens](https://github.com/liustack/modlens) 3956 — The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent
- `[不兼容]` [anionex-agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) 1198 — —
- `[可用]` [hellowind777-helloagents](https://github.com/hellowind777/helloagents) 705 — —
- `[可用]` [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) 641 — Open-source CMA-compatible agent runtime for any model, with MCP tools, sandboxed sessions, audit, replay, and
- `[不兼容]` [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) 879 — 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜DeepSeek Harness-native integration for agent-vision
- `[不兼容]` [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) 372 — Open-source alternative to Claude Cowork — a local-first AI agent desktop app · multi-model · self-evolving sk
- `[可用]` [linhay-harmony-next-skills](https://github.com/linhay/harmony-next.skills) 347 — —
- `[不兼容]` [openma-ai-open-managed-agents](https://github.com/openma-ai/open-managed-agents) 275 — —
- `[可用]` [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) 298 — 为 DeepSeek Harness 带来「跨会话长期记忆 + 后台自我进化」能力的纯插件实现：五轨记忆 · git 分支感知 · 回合内自我审查 · 技能自我进化与技能管理器 · 四轨待办 · COI 调度 · 会话广 〔PR〕
- `[不兼容]` [sealos-skills](https://github.com/labring/sealos-skills) 78 — AI agent skills for Sealos — deploy any project, provision databases, object storage & more with one command
- `[可用]` [bowenliang123-dsh-context](https://github.com/bowenliang123/dsh-context) 1353 — —
- `[不兼容]` [dsh-automation](https://github.com/titanwings/dsh-automation) 91 — DSH 自动化插件：让 Coding 任务按计划在全新 Agent Session 中运行，并由用户或 Agent 创建和管理定时任务
- `[待定]` [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) 193 — Data Agent for DeepSeek Harness: session-scoped database connections with a dedicated agent preset that lets A
- `[未测]` [dsh-work](https://github.com/vibeinging/dsh-work) 585 — Local-first AI workbench for DSH Plugins, combining Agent sessions, project files, data analysis, web research
- `[待定]` [dsh-super-injector](https://github.com/yjh051108/dsh-super-injector) 159 — —
- `[不兼容]` [atlascloudai-atlas-cloud-skills](https://github.com/AtlasCloudAI/atlas-cloud-skills) 29 — —
- `[可用]` [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) 135 — Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authoriz
...
- `[可用]` [dsh-auto-memory](https://github.com/Aik358/dsh-auto-memory) 63 — DSH 自动记忆插件:三层记忆(用户级/项目笔记/每日日志)自动注入与检索、每日反思、可视化面板与设置页,支持继承其他 AI 工具的历史记忆
- `[可用]` [dsh-whale-report](https://github.com/SenmuuuuW/dsh-whale-report) 31 — 🐋 鲸鱼记事本 — 你的 Agent 年度报告：从会话事件日志生成日报/周报/月报/年报，任意区间、只读不改写
- `[不兼容]` [phoenixlucky-zerotoken-skill](https://github.com/phoenixlucky/zerotoken-skill) 16 — —
- `[不兼容]` [huawolf-news-agent](https://github.com/huawolf/news-agent) 15 — —
...
- `[待定]` [project-blueprint](https://github.com/shuguang1994/project-blueprint) 19 — Make any project AI-agent-ready in one command
...
- `[可用]` [omdsh-dev-dsh-plugin-skills](https://github.com/omdsh-dev/dsh-plugin-skills) 13 — —
- `[可用]` [dsh-plugin-product-subagents](https://github.com/shaokeyibb/dsh-plugin-product-subagents) 19 — Role-based Codex / Claude Code / ACP subagent providers for the DeepSeek Harness — continuable children, durab
- `[可用]` [skills](https://github.com/creght-dev/skills) 11 — Codex and agent skills for Cregh.
...
- `[可用]` [dsh-godot-skill](https://github.com/akira399/dsh-godot-skill) 23 — Godot Engine 4.x 全栈游戏开发技能插件 for DeepSeek Harness (DSH) — registers the godot-4-development skill at runtime
- `[可用]` [dsh-session-notification](https://github.com/dingyi222666/dsh-session-notification) 21 — 提供会话完成等四种状态的通知响应，支持浏览器提示和提示词
...
- `[可用]` [dsh-plugin-langfuse](https://github.com/linyp/dsh-plugin-langfuse) 14 — Langfuse observability for DeepSeek Harness (dsh): exports agent sessions as OpenTelemetry trace trees (GenAI
...
- `[可用]` [hootandy321-dsh-agentlink](https://github.com/hootandy321/dsh-Agentlink) 9 — —
...
- `[未测]` [dsh-eval-harness](https://github.com/BiBoyang/dsh-eval-harness) 14 — DSH 插件评测工具：YAML 用例驱动真实 agent 回归评测 + baseline 对比 PASS/WARN/FAIL 门禁｜Regression eval harness for DeepSeek Harness
- `[可用]` [dsh-evolve](https://github.com/william-jin-cmu/dsh-evolve) 12 — 自进化插件：agent 在 session 内随对话给自己长出/剪掉能力 —— evolve_add 热挂载持久化 cordis 插件（下一 step 工具即可见），evolve_remove 可逆卸载，重启自动恢复
...
- `[待定]` [dsh-a2a](https://github.com/dpskh/dsh-a2a) 10 — Agent2Agent mesh for the Harness
- `[可用]` [gengdapeng-dsh-agent-message](https://github.com/GengDaPeng/dsh-agent-message) 5 — —
- `[待定]` [dsh-agent-messaging](https://github.com/happyren/dsh-agent-messaging) 5 — Cross-session agent-to-agent messaging for DeepSeek Harness — address another session by name and deliver a me
...
- `[未测]` [dsh-prompt-persona](https://github.com/Xilin3/dsh-prompt-persona) 14 — DSH plugin: edit the system prompt (deployment persona) from the Settings page, with live preview.
- `[可用]` [dsh-personalize](https://github.com/Zephyr-vibe/dsh-personalize) 3 — Per-host personalization for DSH: custom instructions, local long-term memory, and reply-tone presets.
- `[待定]` [dsh-noema](https://github.com/ZSeven-W/dsh-noema) 129 — Noema long-term memory plugin for DSH: durable, inspectable agent memory with recall tools and a settings page
- `[可用]` [dsh-context-provenance](https://github.com/030611/dsh-context-provenance) 2 — Observe-only provenance ledger over public DeepSeek Harness runtime evidence
...
- `[可用]` [dsh-session-pins](https://github.com/alooshxl/dsh-session-pins) 2 — Persistent pinned-session menu for DeepSeek Harness
- `[不兼容]` [dsh-approval-ai](https://github.com/ang-XWBWZ/dsh-approval-ai) 2 — AI approval answerer for DeepSeek Harness (DSH) using the unified LLM route with fail-closed policy checks.
...
- `[可用]` [dsh-cost](https://github.com/dongsheng123132/dsh-cost) 2 — Evidence-first token cost ledger and budget checks for DeepSeek Harness
- `[不兼容]` [elementor-i-dsh-agentmemory](https://github.com/elementor-i/dsh-agentmemory) 4 — —
- `[可用]` [green-dalii-dsh-plugin-dev-skill](https://github.com/green-dalii/dsh-plugin-dev-skill) 2 — —
...
- `[待定]` [dsh-background-agents](https://github.com/PerryLink/dsh-background-agents) 12 — Interactive long-session background agents for DeepSeek Harness: start a durable continuable child agent, watc
...
- `[不兼容]` [dsh-plugin-subagent-director](https://github.com/SeverusZh/dsh-plugin-subagent-director) 14 — Subagent Director: per-subagent LLM provider/model selection with role templates for DeepSeek Harness (dsh plu
...
- `[可用]` [1while1-dsh-whale-subagent](https://github.com/1while1/dsh-whale-subagent) 1 — —
- `[可用]` [deepseek-harness-memory](https://github.com/2303572348/deepseek-harness-memory) 1 — —
...
- `[可用]` [dsh-plan-first-dev](https://github.com/asd176916847/dsh-plan-first-dev) 1 — DSH 插件：开发前自动进入 plan mode（plan-first development workflow）
...
- `[可用]` [djasdh-interest-memory](https://github.com/djasdh/interest-memory) 3 — —
...
- `[可用]` [hexbee-dsh-skill-panel](https://github.com/hexbee/dsh-skill-panel) 1 — —
- `[待定]` [dsh-im-gateway](https://github.com/jelech/dsh-im-gateway) 3 — An IM gateway for the DeepSeek Harness: bridge messengers into harness agent ses
...
- `[可用]` [dsh-password-prompt](https://github.com/MagicCrazyMan/dsh-password-prompt) 1 — DeepSeek Harness plugin: masked password panel in the Web GUI (password_prompt tool) — bundle + dual-face plug
...
- `[可用]` [session-teleport](https://github.com/omdsh-dev/session-teleport) 1 — —
- `[可用]` [dsh-session-pin](https://github.com/PerryLink/dsh-session-pin) 6 — Pin sessions in the DeepSeek Harness (DSH) web sidebar - dual-face plugin with a hover pin badge, durable pinn
...
- `[待定]` [dsh-session-search](https://github.com/Tieboyh/dsh-session-search) 1 — Index-free cross-agent session search for DeepSeek Harness 〔PR〕
- `[可用]` [dsh-agent-budget](https://github.com/vibeinging/dsh-agent-budget) 1 — Native Harness agent-tree token budget plugin
...
- `[可用]` [dsh-postmortem](https://github.com/zzh-newlearner/dsh-postmortem) 1 — Local-first failure postmortems for DeepSeek Harness sessions.
...
- `[不兼容]` [dsh-turn-budget](https://github.com/randerous/dsh-turn-budget) 0 — Advisory turn step-budget reminders for DeepSeek Harness — loop convergence guar
...
- `[可用]` [DSH-Chrome-devtools](https://github.com/yuzi-ska/DSH-Chrome-devtools) 5 — Real Chrome browser control for DeepSeek Harness agents, powered by Chrome DevTo
...
- `[可用]` [dsh-slice-agent-loop](https://github.com/TT-Wang/dsh-slice-agent-loop) 6 — —
...
- `[可用]` [dsh-patchouli](https://github.com/memorax-agent/dsh-patchouli) 2 — Agent knowledge hub and deepseek-harness plugin
...
- `[可用]` [dsh-skill-importer](https://github.com/saitamahang/dsh-skill-importer) 2 — deepSeek Harness plugin: import and manage skills from files or URLs, with a com
...
- `[可用]` [dsh-lark](https://github.com/omdsh-dev/dsh-lark) 53 — Lark/Feishu IM bot channel for DeepSeek Harness \| 飞书 DeepSeek Harness 插件
...
- `[可用]` [dsh-lark-bot](https://github.com/PlutoKeating/dsh-lark-bot) 38 — dsh-lark-bot：把 DeepSeek Harness (dsh) 桥接进飞书/Lark 的 bot，含完整项目工作区管理、并行任务、多角色 Agent、会话归档与安全网守护（dsh 崩溃后飞书仍可自救）
- `[待定]` [dsh-lark-link](https://github.com/amlyczz/dsh-lark-link) 35 — High-reliability Feishu/Lark bridge for DeepSeek Harness — QR one-click auth, multi-mode agents, card-based co
- `[不兼容]` [dingkaihu63-dsh-robotic-harness](https://github.com/dingkaihu63/dsh-robotic-harness) 20 — —
- `[可用]` [deepseek-manners](https://github.com/Moeblack/deepseek-manners) 15 — DSH 插件：给每次消息后注入感谢语（deepseek-manners）
- `[待定]` [dsh-qq2006](https://github.com/LaplaceYoung/dsh-qq2006) 27 — DSH (DeepSeek Harness) 的 QQ2006 皮肤插件：注册 qq2006 主题、镜像 body[data-ds-skin]、全局皮肤表与完整素材
...
- `[可用]` [dsh-wechat-bridge](https://github.com/gtaifu/dsh-wechat-bridge) 11 — DeepSeek Harness (dsh) transport plugin: chat with your agents on WeChat via official Tencent iLink bot API —
...
- `[可用]` [DSH-Telegram-Relay](https://github.com/congchuanling-dot/DSH-Telegram-Relay) 4 — DSH Relay 让你可以通过 Telegram 远程与 DeepSeek Harness 对话，并接收通知
- `[待定]` [dsh-telegram-channel](https://github.com/hi-wenw/dsh-telegram-channel) 9 — DeepSeek Harness Telegram mobile remote: bind live Web sessions (Codex-style)
...
- `[未测]` [dsh-codex](https://github.com/Yan-Zero/dsh-codex) 59 — Use your ChatGPT subscription in DeepSeek Harness through OpenAI's Codex sign-in
...
- `[可用]` [dsh-testgen](https://github.com/bujue600-arch/dsh-testgen) 2 — Automated unit-test generation for DeepSeek Harness: /testgen command + generate_tests tool that scaffold, run
...
- `[可用]` [dsh-notify-windows](https://github.com/SeverusZh/dsh-notify-windows) 7 — —
- `[可用]` [dsh-email](https://github.com/STARDUSTLC666/dsh-email) 14 — DeepSeek Harness 邮件插件：email_list/read/search/send/folders/attachment 六工具，内置 QQ/163/126/新浪/阿里/Gmail/Outlook/iCl
...
- `[未测]` [dsh-expression](https://github.com/yyh-001/dsh-expression) 83 — 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道
...
- `[可用]` [dsh-voice](https://github.com/3274375092/dsh-voice) 7 — DeepSeek Harness 的语音输入插件:网页里点 🎤(或按Ctrl+空格)说话,识别文本作为普通消息提交进会话
...
- `[可用]` [dsh-plugin-notify](https://github.com/c-ling/dsh-plugin-notify) 6 — DeepSeek Harness 消息提醒插件：回合结束或等待确认时向浏览器、系统、飞书/钉钉/企业微信/通用 Webhook 发送通知
...
- `[可用]` [dsh-feishu](https://github.com/itr-del/dsh-feishu) 1 — Feishu (Lark) IM bridge for DeepSeek Harness (dsh) — a cordis plugin
- `[可用]` [dsh-task-notify](https://github.com/kaotusi/dsh-task-notify) 4 — DeepSeek Harness (DSH) system-level task notifications: approval required / awai
...
- `[可用]` [dsh-plugin-telegram](https://github.com/lovedheart/dsh-plugin-telegram) 1 — DSH plugin for Telegram bot integration
- `[可用]` [dsh-messager](https://github.com/ly6170/dsh-messager) 5 — 基于Deepseek Harness+DeepSeek开发的适用于Deepseek Harness的消息提醒信使，可使用第三方通道（暂时飞书webhook）进行推送
...
- `[不兼容]` [DeepSeek-harness-weixin](https://github.com/sliverp/DeepSeek-harness-weixin) 1 — Weixin ClawBot channel plugin for DeepSeek Harness with QR login and text/image messaging
...
- `[待定]` [dsh-qq-bridge](https://github.com/TomoyoNatsume/dsh-qq-bridge) 12 — DSH plugin for connecting QQ
...
- `[可用]` [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) 61 — 在 DeepSeek Harness 中使用 ChatGPT/Codex 订阅，支持 OAuth 登录、额度与重置时间 \| ChatGPT/Codex subs
...
- `[可用]` [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) 168 — OpenPencil design preview and editing plugin for DSH
...
- `[可用]` [dsh-web-search-pro](https://github.com/anweat/dsh-web-search-pro) 63 — Enhanced, persistent web search plugin for DeepSeek Harness (multi-engine search, SQLite+LRU cache, platform b
- `[可用]` [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) 24 — 为 DSH Web UI 增加跨平台文件拖拽与原始路径插入能力，无需复制文件
- `[未测]` [dsh-recommend](https://github.com/zp-home/dsh-recommend) 21 — DSH 插件生态透明排行与推荐：每日自动抓取 dsh-plugin 话题 + 公开评分模型 + 排行/推荐插件与静态站
- `[可用]` [surfing-plugin](https://github.com/cyijun/surfing-plugin) 16 — SearXNG search and Crawl4AI fetch providers for DeepSeek Harness
...
- `[不兼容]` [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) 66 — OpenMAIC for DeepSeek Harness: classrooms, slides, interactive widgets, and Socratic teaching
...
- `[可用]` [dsh-file-claim](https://github.com/Nwflower/dsh-file-claim) 5 — File claim / protection for concurrent DeepSeek Harness (DSH) sessions working the same workspace: claim/relea
...
- `[待定]` [dsh-plugin-text-translation](https://github.com/1738348785/dsh-plugin-text-translation) 2 — DSH plugin: text & document localization with tag-protected extraction, batch slicing and lossless assembly (g
...
- `[不兼容]` [dsh-paddle-ocr](https://github.com/omdsh-dev/dsh-paddle-ocr) 2 — —
...
- `[可用]` [dsh-plugin-miliastra-toolbox](https://github.com/1475505/dsh-plugin-miliastra-toolbox) 8 — 将千星沙箱（原神千星奇域）知识库接入 Deepseek Harness 的插件
...
- `[不兼容]` [dsh-plugin-auditor](https://github.com/HYY-King/dsh-plugin-auditor) 1 — DSH plugin auditor: pre-flight compatibility check for profile plugin combinations
- `[不兼容]` [dsh-gateway-config](https://github.com/iceprosurface/dsh-gateway-config) 1 — DSH web profile and TapSVC model configuration plugin
- `[可用]` [dsh-plugin-drone](https://github.com/initialencounter/dsh-plugin-drone) 1 — Drag files or floders from explorer into dsh smoothly
...
- `[可用]` [omdsh-dev-dsh-drag-and-drop](https://github.com/omdsh-dev/dsh-drag-and-drop) 4 — —
...
- `[可用]` [schhaohao-dsh-file-explorer](https://github.com/schhaohao/dsh-file-explorer) 1 — —
- `[可用]` [dsh-archive-manager](https://github.com/zimixvx/dsh-archive-manager) 1 — —
...
- `[可用]` [dsh-turn-meta](https://github.com/randerous/dsh-turn-meta) 0 — Opt-in per-step turn metadata for DeepSeek Harness — a minimal first-plugin temp
...
- `[可用]` [dsh-plugin-rag](https://github.com/YYTbit/dsh-plugin-rag) 0 — Local knowledge base RAG for DeepSeek Harness
...
- `[不兼容]` [dsh-plugin-archive-recovery](https://github.com/hisaniwo/dsh-plugin-archive-recovery) 3 — DSH (DeepSeek Harness) plugin: restore archived sessions from an icon in the workspace section header, backed
- `[未定位]` **sunrisepeak-dsh-index** — 占位待复核，判定暂不展示
- `[不兼容]` [dsh-plugin-vision](https://github.com/tdf1995/dsh-plugin-vision) 5 — Vision for text-only LLMs in DeepSeek Harness (DSH): describe images / OCR / VQA
- `[歧义监测]` **context-doctor** — 同名多仓，判定暂不展示
- `[歧义监测]` **dsh-archive-manager** — 同名多仓，判定暂不展示
- `[歧义监测]` **dsh-artifact** — 同名多仓，判定暂不展示 〔PR〕
- `[未测]` [dsh-file-checksum](https://github.com/yan9651688/dsh-file-checksum) 1 — Raw-file SHA-256 and SHA-512 verification plugin for DeepSeek Harness
...
- `[可用]` [dsh-plugin-recall](https://github.com/truelove-dreamer/dsh-plugin-recall) 1 — DeepSeek Harness plugin: cross-session memory for the model
- `[待定]` [dsh-silly-plugin](https://github.com/xiagaogaozi/dsh-silly-plugin) 1 — DSH 酒馆模式：导入 SillyTavern 角色卡（PNG/JSON），自动拆分世界书/正则/脚本并创建同名工作区（#dsh-plugin）

## 🎮 娱乐生活（50）

- `[可用]` [crafter-station-petdex](https://github.com/crafter-station/petdex) 4087 — —
- `[待定]` [small-tailqwq-dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) 2051 — —
- `[可用]` [whale-girl](https://github.com/vlln/whale-girl) 324 — DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴
- `[不兼容]` [pc2005-cloud-dsh-pet](https://github.com/PC2005-cloud/dsh-pet) 610 — —
- `[可用]` [liyupi-dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) 94 — —
- `[可用]` [awu12277-dsh-stock-watch](https://github.com/Awu12277/dsh-stock-watch) 79 — —
- `[可用]` [deepseek-pet](https://github.com/keleus/deepseek-pet) 45 — 在你的deepseek-harness上养一只吃白饭的大蓝鲸
- `[待定]` [dsh-emoji](https://github.com/hellodigua/dsh-emoji) 43 — 让 AI 回复加入自定义表情，支持Bilibili、小红书、贴吧、知乎等多平台表情包，或自定义表情
- `[可用]` [dsh-minigames](https://github.com/lhh010/dsh-minigames) 30 — DSH Web UI 右侧小游戏面板：18 款离线小游戏（恐龙跳一跳 / 俄罗斯方块 / 坦克大战 / 扫雷 / 2048 / 数独 / 吃豆人 / 跟枪练习等），可扩展游戏注册表，等待模型回复或修 bug 时的摸鱼神器
- `[不兼容]` [huanlinoto-dsh-plugin-pet-rs](https://github.com/HuanLinOTO/dsh-plugin-pet-rs) 22 — —
- `[可用]` [dsh-gomoku](https://github.com/omdsh-dev/dsh-gomoku) 23 — 在DSH中与AI下五子棋，也可以让AI对局，看哪个AI棋力更强
...
- `[可用]` [dsh-live2d-pets](https://github.com/cyanfish-x/dsh-live2d-pets) 23 — Live2D 桌宠插件 for DeepSeek Harness：Agent 状态镜像 + 互动陪伴，内置宽松许可预设模型 / Live2D pet plugin: agent state mirror + intera
...
- `[可用]` [dsh-plugin-pet](https://github.com/c-ling/dsh-plugin-pet) 4 — DeepSeek Harness 桌面电子宠物插件：跟随 agent 状态变换心情的内置/自定义/Codex 精灵图伙伴
- `[可用]` [dsh-whale-pet](https://github.com/lglglglgy/dsh-whale-pet) 3 — dsh-whale-pet
- `[不兼容]` [dsh-auto-chess](https://github.com/omdsh-dev/dsh-auto-chess) 2 — DSH Web里的自走棋插件：人机对战或双AI对弈
...
- `[可用]` [dsh-memento](https://github.com/PerryLink/dsh-memento) 88 — Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.me
...
- `[未测]` [deepseek-harness-whale-pet](https://github.com/Vinsenz0122/deepseek-harness-whale-pet) 1 — DeepSeek Harness Web 的可拖动鲸鱼女仆状态宠物插件
...
- `[不兼容]` [dsh-desktop-pet](https://github.com/2002yxy/dsh-desktop-pet) 1 — Unofficial customizable desktop-pet plugin for DeepSeek Harness
...
- `[不兼容]` [anywhere-labs-deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) 25948 — —
- `[不兼容]` [dataelement-dsh-desktop](https://github.com/dataelement/dsh-desktop) 5676 — —
- `[可用]` [hairyf-deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop) 2000 — —
- `[可用]` [sepinetam-mcp-for-stata](https://github.com/SepineTam/mcp-for-stata) 258 — —
- `[不兼容]` [lum1104-dsh-browser](https://github.com/Lum1104/dsh-browser) 636 — —
- `[未测]` [Bigfish](https://github.com/turtle2209/Bigfish) 315 — Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带桌面萌宠
- `[待定]` [Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) 161 — DSH桌面端，支持主题和背景图等多种个性化配置
- `[不兼容]` [ningbainb-deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) 493 — —
- `[可用]` [dsh-notification](https://github.com/omdsh-dev/dsh-notification) 83 — Desktop notifications for DeepSeek Harness turn completions, with per-outcome controls and include/exclude key
- `[不兼容]` [kelai141-dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) 379 — —
- `[不兼容]` [bruc3van-dsh-desktop](https://github.com/bruc3van/dsh-desktop) 85 — —
- `[可用]` [hanelalo-browser-bridge](https://github.com/hanelalo/browser-bridge) 50 — —
...
- `[不兼容]` [deepseek-harness-wallet](https://github.com/feibi-mochi/deepseek-harness-wallet) 71 — Balance monitoring, per-session spend & token tracking, low-balance alerts, and an official recharge shortcut
- `[不兼容]` [ego-browser](https://github.com/Fisfzy/ego-browser) 154 — DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、
- `[可用]` [cc1252-deepseek-harness-desktop](https://github.com/cc1252/deepseek-harness-desktop) 19 — —
- `[可用]` [flymysql-dsh-remote](https://github.com/flymysql/dsh-remote) 73 — —
- `[不兼容]` [dsh-mobile](https://github.com/lehhair/dsh-mobile) 26 — —
- `[可用]` [liguobao-dsh-desktop](https://github.com/liguobao/dsh-desktop) 35 — —
- `[可用]` [runzhliu-deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) 78 — —
- `[可用]` [chyra-moon-deepseek-harness-desktop](https://github.com/chyra-moon/deepseek-harness-desktop) 19 — —
...
- `[可用]` [lbwnb666-ai-deepseekharnessremotegateway](https://github.com/lbwnb666-ai/DeepSeekHarnessRemoteGateway) 22 — —
- `[可用]` [omdsh-dev-deepseek-harness-desktop](https://github.com/omdsh-dev/deepseek-harness-desktop) 8 — —
- `[可用]` [qyqy-1109-deepseek-harness-desktop](https://github.com/qyqy-1109/deepseek-harness-desktop) 8 — —
- `[可用]` [alliottech-deepseek-harness-docker](https://github.com/AlliotTech/deepseek-harness-docker) 18 — —
- `[可用]` [dsh-playwright-browser](https://github.com/Clizo1209/dsh-playwright-browser) 14 — Playwright browser automation for DeepSeek Harness｜面向 DeepSeek Harness 的 Playwright 浏览器自动化插件
- `[可用]` [foolgry-dsh-desktop](https://github.com/foolgry/dsh-desktop) 10 — —
...
- `[不兼容]` [dsh-better-browser](https://github.com/titanwings/dsh-better-browser) 11 — DSH 真实浏览器插件：通过 Kimi WebBridge 让 Agent 操作用户已登录的浏览器，并提供 13 个 webbridge_* 工具
- `[可用]` [1m01m0-deepseek-harness-desktop](https://github.com/1m01m0/deepseek-harness-desktop) 5 — —
- `[可用]` [mcp-server](https://github.com/AtlasCloudAI/mcp-server) 8 — MCP server for Atlas Cloud - AI API aggregation platform for image/video generation and LLM
...
- `[待定]` [sorsama-deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) 70 — —
...
- `[可用]` [dsh-desk](https://github.com/majiayu000/dsh-desk) 14 — Installable Tauri desktop distribution for DeepSeek Harness with a bundled runtime, trusted plugin review, and
- `[可用]` [ankocd-dsh-server-deployment](https://github.com/AnkoCD/dsh-server-deployment) 29 — —
...
- `[不兼容]` [longyu065-dsh-desktop](https://github.com/longyu065/dsh-desktop) 3 — —
...
- `[可用]` [anweat-dsh-browser](https://github.com/anweat/dsh-browser) 21 — —
...
- `[不兼容]` [flee42-dsh-desktop](https://github.com/flee42/dsh-desktop) 2 — —
- `[可用]` [haoyueqin-deepseek-harness-desktop](https://github.com/HaoyueQin/deepseek-harness-desktop) 6 — —
- `[可用]` [kevenxz-dsh-desktop](https://github.com/kevenxz/dsh-desktop) 2 — —
...
- `[可用]` [mapan0424-deepseek-harness-desktop](https://github.com/mapan0424/deepseek-harness-desktop) 4 — —
- `[不兼容]` [microtree9-deepseek-harness-desktop](https://github.com/microtree9/deepseek-harness-desktop) 133 — —
...
- `[待定]` [sandbox-nono](https://github.com/omdsh-dev/sandbox-nono) 2 — nono沙盒支持
- `[可用]` [dsh-open-browser](https://github.com/peach0x33a/dsh-open-browser) 2 — —
- `[不兼容]` [pig1et7-deepseek-harness-desktop](https://github.com/pig1et7/DeepSeek-Harness-Desktop) 3 — —
- `[不兼容]` [pmlpl-deepseek-harness-desktop](https://github.com/pmlpl/deepseek-harness-desktop) 2 — —
...
- `[不兼容]` [dsh-calendar](https://github.com/STARDUSTLC666/dsh-calendar) 2 — DeepSeek Harness 日历插件：calendar_list/create/update/delete/search 五工具，CalDAV 协议支持 Google/iCloud/Nextcloud/自定义端点，
...
- `[可用]` [beex-labs-dsh-desktop-plugin](https://github.com/beex-labs/dsh-desktop-plugin) 1 — —
...
- `[可用]` [bluecobaltum-dsh-lan-proxy](https://github.com/bluecobaltum/dsh-lan-proxy) 1 — —
...
- `[不兼容]` [evanmormmm-deepseek-harness-desktop](https://github.com/evanmormmm/deepseek-harness-desktop) 1 — —
...
- `[不兼容]` [hialuoy-deepseek-harness-desktop](https://github.com/hialuoy/deepseek-harness-desktop) 1 — —
- `[不兼容]` [huangj17-deepseek-harness-desktop](https://github.com/huangj17/deepseek-harness-desktop) 14 — —
- `[可用]` [ilimei-dsh-desktop](https://github.com/ilimei/dsh-desktop) 1 — —
...
- `[不兼容]` [michengai-deepseek-harness-desktop](https://github.com/MichengAI/deepseek-harness-desktop) 76 — —
- `[不兼容]` [minilaba-deepseek-harness-desktop](https://github.com/MiniLaba/deepseek-harness-desktop) 1 — —
- `[可用]` [mrbbbaixue-dsh-desktop](https://github.com/mrbbbaixue/dsh-desktop) 4 — —
...
- `[可用]` [dsh-launcher-lifetime](https://github.com/Ruler4396/dsh-launcher-lifetime) 1 — DeepSeek Harness (dsh) plugin: control the dsh service lifetime (always-on / tray / follow-window) for the dsh
- `[不兼容]` [sdsjnslwq-netizen-deepseek-harness-desktop](https://github.com/sdsjnslwq-netizen/deepseek-harness-desktop) 1 — —
...
- `[可用]` [dsh-llm-proxy](https://github.com/Ye-Yu-Mo/dsh-llm-proxy) 5 — DeepSeek Harness (dsh) 全局 HTTP 代理插件：undici setGlobalDispatcher + EnvHttpProxyAge
- `[可用]` [dsh-mcp-settings](https://github.com/xluomo/dsh-mcp-settings) 1 — dsh mcp服务器配置管理
...
- `[可用]` [computer-use-plus](https://github.com/Ethanout/computer-use-plus) 3 — Low-token, low-latency Windows computer-use MCP with learned shortcuts, UIA/CDP/
...
- `[不兼容]` [onenightcarnival-deepseek-harness-desktop](https://github.com/Onenightcarnival/deepseek-harness-desktop) 3 — —
...
- `[待定]` [dsh-browser-control](https://github.com/PangYiMing/dsh-browser-control) 0 — DSH plugin for controlling browsers (CDP/Playwright) — DeepSeek Harness 操控浏览器插件
...
- `[可用]` [egnmosk-dsh-browser-bridge](https://github.com/egnmosk/dsh-browser-bridge) 2 — —
...
- `[可用]` [alaliqing-claude-paper](https://github.com/alaliqing/claude-paper) 336 — —
- `[不兼容]` [dsh-deep-research](https://github.com/omdsh-dev/dsh-deep-research) 23 — Adaptive deep-research orchestrator plugin for DeepSeek Harness (official workflow engine, cybernetics/informa
- `[待定]` [dsh-deepresearch](https://github.com/havingautism/dsh-deepresearch) 14 — —
...
- `[未测]` [dsh-academic-research](https://github.com/userInner/dsh-academic-research) 1 — Evidence-grounded bilingual academic research plugin for DeepSeek Harness and On
...
- `[可用]` [deepseek-ai-deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 221561 — —
- `[可用]` [devin-axis-ipollowork](https://github.com/Devin-AXIS/iPolloWork) 5892 — —
- `[不兼容]` [awesome-dsh-plugin-awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) 15454 — —
- `[不兼容]` [imsai-sh-zhuzhiliao](https://github.com/imsai-sh/zhuzhiliao) 2881 — —
- `[可用]` [adamplatin123-awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) 1464 — —
- `[可用]` [PicGo-Core](https://github.com/PicGo/PicGo-Core) 984 — :zap:The ultimate image uploading engine
- `[不兼容]` [0xsline-awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) 1051 — —
- `[可用]` [mnemon-dev-mnemon](https://github.com/mnemon-dev/mnemon) 573 — —
- `[不兼容]` [electricitysheep-dsh-handbook](https://github.com/Electricitysheep/dsh-handbook) 768 — —
- `[可用]` [morluto-rea](https://github.com/morluto/rea) 401 — —
- `[可用]` [bruc3van-awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) 332 — —
- `[可用]` [cofy-x-axern](https://github.com/cofy-x/axern) 59 — —
- `[可用]` [humblebanana-open-record-replay](https://github.com/humblebanana/open-record-replay) 143 — —
- `[不兼容]` [ariestar-sivtr](https://github.com/Ariestar/sivtr) 269 — —
- `[不兼容]` [ruler4396-dsh-launcher](https://github.com/Ruler4396/dsh-launcher) 204 — —
- `[可用]` [nagi-ovo-dsh-find-plugins](https://github.com/Nagi-ovo/dsh-find-plugins) 173 — —
- `[可用]` [drewnekota-cetus](https://github.com/drewnekota/cetus) 144 — —
- `[可用]` [modsearch](https://github.com/liustack/modsearch) 468 — The web plugin for DeepSeek Harness, and the search bridge for every model without native web access
- `[可用]` [sikao-engine-kimix](https://github.com/Sikao-Engine/KimiX) 111 — —
- `[不兼容]` [hikariming-dshfind](https://github.com/hikariming/dshfind) 253 — —
- `[不兼容]` [pulseaiclub-phi](https://github.com/pulseaiclub/phi) 377 — —
- `[可用]` [libukai-awesome-deepseek-harness](https://github.com/libukai/awesome-deepseek-harness) 255 — —
- `[不兼容]` [dominic789654-awesome-deepseek-harness](https://github.com/Dominic789654/awesome-deepseek-harness) 242 — —
- `[未测]` [deep-flow](https://github.com/zimenglan-sysu-512/deep-flow) 71 — —
- `[不兼容]` [alex-yanggg-awesome-dsh-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) 96 — —
- `[可用]` [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) 115 — deepseek harness对话和代码状态回退插件 \| DSH — rewind conversation and workspace state, powered by a persistent Change Le
- `[可用]` [ayase34-gal-view](https://github.com/Ayase34/gal-view) 169 — —
- `[可用]` [pingfanfan-hello-dsh](https://github.com/pingfanfan/hello-dsh) 92 — —
- `[可用]` [lyn-77-promentor](https://github.com/Lyn-77/ProMentor) 74 — —
- `[可用]` [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) 413 — AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH)
...
- `[可用]` [morluto-jacobian](https://github.com/morluto/jacobian) 191 — —
- `[不兼容]` [beancookie-awesome-dsh-plugin](https://github.com/beancookie/awesome-dsh-plugin) 139 — —
- `[可用]` [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) 292 — DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步
- `[不兼容]` [like-study1-oh-my-dsh](https://github.com/like-study1/Oh-My-DSH) 85 — —
- `[待定]` [dsh-multica-runtime](https://github.com/multica-ai/dsh-multica-runtime) 64 — Support dsh runtime on Multica.
- `[不兼容]` [morluto-flameox](https://github.com/morluto/flameox) 121 — —
- `[可用]` [noob-stupid-dsh-plugin-hub](https://github.com/Noob-stupid/dsh-plugin-hub) 83 — —
- `[可用]` [openguardrails-openguardrails](https://github.com/openguardrails/openguardrails) 45 — —
...
- `[不兼容]` [n0zom1z0-th08](https://github.com/N0zoM1z0/th08) 92 — —
- `[可用]` [dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) 111 — Template for deepseek-harness plugin development.
- `[不兼容]` [ali-meoo-meoo-cli](https://github.com/ali-meoo/meoo-cli) 25 — —
- `[可用]` [dsh-computer-use](https://github.com/Anionex/dsh-computer-use) 41 — 为 DeepSeek Harness 提供电脑控制插件：新鲜 Accessibility 观测、过期状态拒绝、作用域权限与安全输入（目前支持macos）｜Accessibility-first macOS Compute
...
- `[可用]` [morluto-leantoken](https://github.com/morluto/leantoken) 23 — —
- `[不兼容]` [kejixiaoliang-awesome-dsh-plugins](https://github.com/kejixiaoliang/awesome-dsh-plugins) 42 — —
...
- `[待定]` [dsh-scholar](https://github.com/lzszq/dsh-scholar) 43 — dsh-scholar
- `[不兼容]` [cclank-dsh-plugin-hub](https://github.com/cclank/dsh-plugin-hub) 22 — —
- `[可用]` [blender](https://github.com/CheshireJCat/blender) 26 — DeepSeek Harness plugin for complete Blender 3D modeling, reconstruction, rendering, validation, and export wo
- `[可用]` [dqsjqian-aria](https://github.com/dqsjqian/Aria) 85 — —
...
- `[可用]` [modusensus-dsh-mneme](https://github.com/modusensus/dsh-mneme) 95 — —
- `[待定]` [fabric](https://github.com/omdsh-dev/fabric) 18 — 一种类似MC Fabric的hook处理器
- `[不兼容]` [ayuanwong-deepseek-harness-ux](https://github.com/ayuanwong/deepseek-harness-ux) 15 — —
- `[可用]` [biociao-dsh-science](https://github.com/biociao/dsh-science) 39 — —
...
- `[可用]` [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) 80 — A DeepSeek Harness (dsh) web plugin that replaces the "Deep diving…" turn-status label with phase-aware, typew
- `[不兼容]` [fakechris-dsh-harness-ops](https://github.com/fakechris/dsh-harness-ops) 15 — —
- `[可用]` [imsai-sh-awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) 229 — —
- `[可用]` [linenxi-ctrl-dsh-vision](https://github.com/linenxi-ctrl/dsh-vision) 11 — —
- `[可用]` [lixiaoyiao-deepseek-harness-action](https://github.com/Lixiaoyiao/deepseek-harness-action) 16 — —
- `[不兼容]` [omdsh-dev-dsh-plugin-dev](https://github.com/omdsh-dev/dsh-plugin-dev) 14 — —
- `[不兼容]` [dsh-security-audit](https://github.com/omdsh-dev/dsh-security-audit) 15 — DSH 本机安全审计插件：配置/插件来源/会话/网络暴露面，只读脱敏风险报告
- `[不兼容]` [billliao-awesome-dsh-plugin](https://github.com/billLiao/awesome-dsh-plugin) 14 — —
- `[不兼容]` [bin-hy-dsh](https://github.com/Bin-hy/dsh) 18 — —
...
- `[可用]` [dsh-sticky-note](https://github.com/Meredith2328/dsh-sticky-note) 47 — 左下角便签：随手记点子/感想/TODO，实时保存到归档目录，清单+悬浮归档
...
- `[可用]` [nowint-oh-my-dsh](https://github.com/NoWint/Oh-My-DSH) 17 — —
- `[可用]` [railgun0325-dsh-phone](https://github.com/railgun0325/dsh-phone) 18 — —
...
- `[可用]` [dsh-agy](https://github.com/chaos-03x/dsh-agy) 36 — Google Antigravity (agy) OAuth auth + model access plugin for DeepSeek Harness: multi-account pool, 429 rotati
...
- `[可用]` [pi2dsh](https://github.com/weijiafu14/pi2dsh) 189 — Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plu
- `[可用]` [dsh-hdc-bridge](https://github.com/1na-ko/dsh-hdc-bridge) 16 — DSH 原生鸿蒙开发助手：hdc 设备闭环调试 + 离线官方知识层（Tier-1 随包）+ DevEco CLI 构建通道 / DSH-native HarmonyOS dev assistant: hdc device
...
- `[可用]` [dsh-compaction-instant](https://github.com/KitDoesIt/dsh-compaction-instant) 14 — LLM-free lossless* compaction engine for DeepSeek Harness
...
- `[可用]` [plugin-template](https://github.com/omdsh-dev/plugin-template) 14 — 基于原turtle ui官方仓库创建的plugin模板仓库
- `[可用]` [deepseek-harness-acp](https://github.com/openma-ai/deepseek-harness-acp) 28 — ACP server implementation for DeepSeek harness
- `[未测]` [dsh-ramify](https://github.com/yanglongyun/dsh-ramify) 14 — Ramify 是 DeepSeek Harness 的创意分支画布插件，用树状工作区生成、对比和迭代多个可交互方案
...
- `[不兼容]` [dsh-plugin-auto-blame](https://github.com/HuanLinOTO/dsh-plugin-auto-blame) 11 — 模型回合结束后用 LLM 生成 3 条批判性跟进建议，点击即发送 \| After a model turn, an LLM generates 3 critical follow-up suggestions shown
...
- `[可用]` [dsh-tavern](https://github.com/Player-MINEPIG/dsh-tavern) 13 — A plugin which makes dsh compatible with SillyTavern artifacts.
...
- `[不兼容]` [zotero-harvest](https://github.com/Fisfzy/zotero-harvest) 4 — Zotero 文献采集入库插件（DSH external plugin）：多源检索（OpenAlex/arXiv/Crossref/Europe PMC/Semantic Scholar）+ OA 下载链接解析（Unpa
...
- `[可用]` [laoyuehanni-dsh-token-usage](https://github.com/LaoYueHanNi/dsh-token-usage) 11 — —
- `[可用]` [dsh-split-panes](https://github.com/lehhair/dsh-split-panes) 6 — —
- `[不兼容]` [Deepseek-Harness-](https://github.com/Links2008/Deepseek-Harness-) 37 — —
...
- `[不兼容]` [1514100951-dsh-usage-footer](https://github.com/1514100951/dsh-usage-footer) 3 — —
- `[可用]` [dsh-stats-dashboard](https://github.com/1HelloMan1/dsh-stats-dashboard) 3 — DSH plugin: provider/model usage stats dashboard with response speed, call log, token totals, cache rate, cost
...
- `[可用]` [dsh-cost-chip](https://github.com/boNeXY226/dsh-cost-chip) 3 — DeepSeek Harness (dsh) 插件：/cost 查看每个会话花费 + 可拖拽的悬浮费用胶囊
- `[不兼容]` [ceelog-dsh-plugins](https://github.com/Ceelog/dsh-plugins) 8 — —
- `[不兼容]` [cute-baobao-dsh-usage-meter](https://github.com/cute-baobao/dsh-usage-meter) 3 — —
...
- `[可用]` [dsh-llm-wiki](https://github.com/detpecca/dsh-llm-wiki) 3 — —
- `[待定]` [dsh-lineage](https://github.com/dongsheng123132/dsh-lineage) 3 — Content-addressed artifact, fact, action and report lineage for DeepSeek Harness
...
- `[不兼容]` [dsh-mc-launcher](https://github.com/hellosky983/dsh-mc-launcher) 9 — Minecraft launcher built on DeepSeek Harness: full-screen launcher UI (root slot) with version download, Micro
...
- `[可用]` [awesome-dsh-background-plugin](https://github.com/leavestring/awesome-dsh-background-plugin) 6 — DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮
- `[不兼容]` [maimorylab-dib](https://github.com/MaimoryLab/dib) 3 — —
- `[不兼容]` [dsh-LAN](https://github.com/MrMu666/dsh-LAN) 10 — 为DeepSeek  harness开启局域网访问及移动端页面的插件
- `[不兼容]` [oitsukiii-deepseek-harness-lan](https://github.com/oitsukiii/deepseek-harness-lan) 6 — —
- `[待定]` [7d7d](https://github.com/omdsh-dev/7d7d) 3 — —
...
- `[可用]` [perrylink-dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) 15 — —
...
- `[可用]` [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) 54 — dsh-passwords: DeepSeek Harness login gateway - first-run setup, at-rest encryption, brute-force lockout, audi
...
- `[可用]` [dsh-restart](https://github.com/anweat/dsh-restart) 7 — —
...
- `[不兼容]` [dsh-plugin-consult](https://github.com/biuboomc/dsh-plugin-consult) 2 — DeepSeek Harness peer-consult plugin: talk to a fork of another session without mutating the original
- `[不兼容]` [blaczz-dsh-achievements](https://github.com/Blaczz/dsh-achievements) 2 — —
- `[可用]` [cccakeee-awesome-dsh-plugins](https://github.com/cccakeee/awesome-dsh-plugins) 8 — —
- `[可用]` [coppynight-dsh-doctor](https://github.com/coppynight/dsh-doctor) 5 — —
- `[可用]` [dsh-plugin-center](https://github.com/cpp285/dsh-plugin-center) 17 — A compact discovery and lifecycle console for DeepSeek Harness plugins.
...
- `[可用]` [dsh-bilibili](https://github.com/CZX2244/dsh-bilibili) 10 — —
- `[可用]` [dsh-action-parity](https://github.com/dongsheng123132/dsh-action-parity) 2 — Cross-surface action binding and replay parity evidence for DeepSeek Harness
- `[可用]` [dsh-narrative-ledger](https://github.com/dongsheng123132/dsh-narrative-ledger) 2 — Verifiable narrative state, continuity and character-knowledge ledger for DeepSeek Harness
- `[可用]` [dsh-policy-drift-proof](https://github.com/dongsheng123132/dsh-policy-drift-proof) 2 — Content-addressed, value-redacted policy drift evidence for DeepSeek Harness
- `[不兼容]` [dsh-recovery-proof](https://github.com/dongsheng123132/dsh-recovery-proof) 2 — Read-only recovery drill evidence for DeepSeek Harness
- `[不兼容]` [dsh-release-proof](https://github.com/dongsheng123132/dsh-release-proof) 2 — Reproducible multi-source release evidence for DeepSeek Harness artifacts and mirrors
- `[不兼容]` [dongsheng123132-dsh-switch](https://github.com/dongsheng123132/dsh-switch) 2 — —
- `[不兼容]` [dsh-xiapan-media](https://github.com/dongsheng123132/dsh-xiapan-media) 2 — Native vision, gpt-image-2 and Seedance plugins for DeepSeek Harness via Xiapan Cloud
...
- `[可用]` [golitter-dsh-deepseek-billing](https://github.com/golitter/dsh-deepseek-billing) 2 — —
- `[可用]` [dsh-multi-tenant](https://github.com/GuoMonth/dsh-multi-tenant) 10 — Multi-tenant SaaS extension for DeepSeek Harness (DSH): tenant identity, session isolation, authorization, ten
- `[可用]` [dsh-sticky-disclosure](https://github.com/Han-1413141/dsh-sticky-disclosure) 2 — DSH Web client plugin: collapse every expanded section (Think / tool cards) in the conversation in one click,
- `[空仓监测]` **dsh-report-html** — GitHub 无此仓库，判定暂不展示
- `[不兼容]` [hyls9527-dsh-plugins](https://github.com/hyls9527/dsh-plugins) 3 — —
- `[可用]` [dsh-tool-underseal](https://github.com/Hyperionjust/dsh-tool-underseal) 2 — —
...
- `[可用]` [jinguanghai-deepseek-harness-forge-plugins](https://github.com/jinguanghai/deepseek-harness-forge-plugins) 2 — —
- `[可用]` [jinsong-zhou-safe-find-dsh-plugins](https://github.com/Jinsong-Zhou/safe-find-dsh-plugins) 3 — —
- `[可用]` [dsh-think-any-lang](https://github.com/lco117/dsh-think-any-lang) 2 — DeepSeek Harness (DSH) plugin: a "Thinking Language" selector under Settings → General that tells the model wh
- `[可用]` [leawind-dsh-minecraft-dev](https://github.com/Leawind/dsh-minecraft-dev) 4 — —
- `[可用]` [dsh-task-relay](https://github.com/LeslieWylie/dsh-task-relay) 2 — DSH 跨会话任务接力板：task_push/list/claim/done + handoff_write/read
...
- `[可用]` [dsh-daily-progress](https://github.com/omdsh-dev/dsh-daily-progress) 2 — —
- `[不兼容]` [dsh-ernie-image](https://github.com/omdsh-dev/dsh-ernie-image) 2 — —
- `[不兼容]` [dsh-fun-typewriter](https://github.com/omdsh-dev/dsh-fun-typewriter) 2 — DSH Typewriter: WebAudio typing ambience with a plugin-owned settings API and zero audio assets
...
- `[不兼容]` [dsh-voice-funasr](https://github.com/omdsh-dev/dsh-voice-funasr) 2 — —
- `[可用]` [onezero-y-dsh-plugin-kit](https://github.com/OneZero-Y/dsh-plugin-kit) 2 — —
- `[不兼容]` [dsh-cmd-starter](https://github.com/PandaColour/dsh-cmd-starter) 2 — 为deepseek-harness提供一个命令行启动工具，让它 --append-prompt  --resume 等类claude命令
...
- `[不兼容]` [dsh-pixluna](https://github.com/PixLunaLab/dsh-pixluna) 2 — dsh-plugin-pixluna \| 让 DSH 自己看涩图！
...
- `[可用]` [securstack-dsh-plugin](https://github.com/securstack/securstack-dsh-plugin) 2 — SecurStack adapter for DeepSeek Harness: run repository security scans, policy gates, doctor diagnostics, and
- `[可用]` [dsh-serenity-plugin](https://github.com/tellmewhattodo/dsh-serenity-plugin) 6 — dsh-serenity-plugin
...
- `[待定]` [TokenLedger](https://github.com/zh667/TokenLedger) 198 — Token usage accounting for DeepSeek Harness, reconciled against New API and Sub2API relay-site billing
...
- `[可用]` [atlascloudai-cli](https://github.com/AtlasCloudAI/cli) 3 — —
...
- `[不兼容]` [cherrchen-deepseek-harness-electron](https://github.com/cherrchen/deepseek-harness-electron) 3 — —
- `[可用]` [dsh-plugin-colorscheme](https://github.com/Civitasv/dsh-plugin-colorscheme) 1 — Colorscheme Plugin For DeepSeek Harness
- `[可用]` [cooljser-dsh-plugin-portal](https://github.com/cooljser/dsh-plugin-portal) 3 — —
- `[待定]` [dsh-model-thinking](https://github.com/cyberlieflife/dsh-model-thinking) 3 — DSH (DeepSeek Harness) web plugin: thinking intensity / reasoning effort settings for custom OpenAI-compatible
- `[可用]` [czzzlq-deepseek-harness-background](https://github.com/czzzlq/deepseek-harness-background) 1 — —
- `[不兼容]` [d-ouyang-dsh-plugin-md-outline](https://github.com/d-ouyang/dsh-plugin-md-outline) 1 — —
- `[可用]` [dsh-deepseek-price-timer](https://github.com/dacs2019/dsh-deepseek-price-timer) 1 — ⏱️ DeepSeek peak/off-peak price timer for the DeepSeek Harness Web GUI — live of
...
- `[可用]` [dsh-windows-readiness-proof](https://github.com/dongsheng123132/dsh-windows-readiness-proof) 1 — Content-addressed readiness proof for sanitized DeepSeek Harness observations on
- `[可用]` [dsh-pub-dsh-pub](https://github.com/dsh-pub/dsh-pub) 4 — —
- `[不兼容]` [dsh-conversation-rewind](https://github.com/DTSFO/dsh-conversation-rewind) 1 — —
...
- `[可用]` [freehul-sgme](https://github.com/freehul/sgme) 14 — —
...
- `[可用]` [honghudavy-star-dsh-plugins-4u](https://github.com/honghudavy-star/DSH_plugins_4U) 1 — —
- `[可用]` [huangmouren2023-deepseek-harness-toolkit](https://github.com/huangmouren2023/deepseek-harness-toolkit) 1 — —
...
- `[可用]` [jinbaozi-deepseek-harness-plugins](https://github.com/jinbaozi/deepseek-harness-plugins) 1 — —
- `[可用]` [jinsong-zhou-dsh-html-canvas](https://github.com/Jinsong-Zhou/dsh-html-canvas) 1 — —
...
- `[可用]` [kestiny18-dsh-plugins](https://github.com/kestiny18/dsh-plugins) 3 — —
- `[可用]` [linqunxun-dsh-plugins](https://github.com/linqunxun/dsh-plugins) 1 — —
- `[可用]` [loner1024-deepseek-harness-sdk-rs](https://github.com/Loner1024/deepseek-harness-sdk-rs) 1 — —
...
- `[可用]` [dsh-plugin-description](https://github.com/MysaDC/dsh-plugin-description) 1 — mount one row in the composition and every plugin card on the Web Settings plugin list page gets a bilingual (
- `[不兼容]` [nitrazepam01-dsh-web-search-tavily](https://github.com/nitrazepam01/dsh-web-search-tavily) 3 — —
- `[可用]` [dsh-conversation-share](https://github.com/omdsh-dev/dsh-conversation-share) 1 — DeepSeek Harness plugin: dsh-conversation-share
- `[可用]` [omdsh-dev-dsh-scout](https://github.com/omdsh-dev/dsh-scout) 1 — —
...
- `[可用]` [perrylink-dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) 26 — —
...
- `[不兼容]` [renat3u-dsh-paseo](https://github.com/renat3u/dsh-paseo) 4 — —
...
- `[可用]` [dsh-soul-md](https://github.com/Scorp1o117/dsh-soul-md) 6 — Soul.md persona for DeepSeek Harness \| DeepSeek Harness 人设卡插件
- `[可用]` [falsify-dsh](https://github.com/shi275773124/falsify-dsh) 1 — DeepSeek Harness adapter for the public Falsify CLI
- `[可用]` [sisyphussq-dsh-plugins](https://github.com/SisyphusSQ/dsh-plugins) 1 — —
- `[待定]` [deepseek-harness-vision-plugin](https://github.com/sjscy05/deepseek-harness-vision-plugin) 1 — —
- `[不兼容]` [dsh-task-progress-notifier](https://github.com/sjscy05/dsh-task-progress-notifier) 1 — —
- `[待定]` [matlab-modelsim-vivado-plugin](https://github.com/sjscy05/matlab-modelsim-vivado-plugin) 1 — DeepSeek Harness plugin: MATLAB + ModelSim + Vivado full-flow tools for digital
- `[待定]` [snowcrescenter-tech-dsh-launcher](https://github.com/SnowCrescenter-tech/dsh-launcher) 1 — —
- `[可用]` [soolaugust-deepseek-harness-cli](https://github.com/soolaugust/deepseek-harness-cli) 3 — —
...
- `[可用]` [dsh-command-opt](https://github.com/csiroqa/dsh-command-opt) 1 — —
- `[不兼容]` [dsh-cost-display](https://github.com/misakimiku2/dsh-cost-display) 1 — DeepSeek Harness 成本显示插件
- `[可用]` [dsh-cost-ledger](https://github.com/suimi8/dsh-cost-ledger) 1 — —
...
- `[未测]` [dsh-eval-regression](https://github.com/aryswisnu/dsh-eval-regression) 1 — —
- `[未测]` [dsh-everything-oauth](https://github.com/kam74515-boop/dsh-everything-oauth) 3 — —
- `[未测]` [dsh-eye-care](https://github.com/Anionex/dsh-eye-care) 3 — —
...
- `[可用]` [dsh-product-delivery-workflow](https://github.com/wellorbetter/dsh-product-delivery-workflow) 1 — —
...
- `[不兼容]` [dsh-http-probe](https://github.com/TwistedRiCen/dsh-http-probe) 1 — A bounded HTTP probe tool plugin for DeepSeek Harness.
...
- `[待定]` [deepseek-harness-flow](https://github.com/alison-xx/deepseek-harness-flow) 0 — Visual workflows and multi-model evaluation for DeepSeek Harness
- `[可用]` [alyosha28-deep-option](https://github.com/Alyosha28/deep_option) 2 — —
- `[可用]` [asdf17128-dsh-doctor](https://github.com/asdf17128/dsh-doctor) 1 — —
- `[不兼容]` [baiyun200-dsh-dashboard](https://github.com/baiyun200/dsh-dashboard) 2 — —
...
- `[不兼容]` [DeepSeek-Harness-Breathing-BG](https://github.com/CharserHH/DeepSeek-Harness-Breathing-BG) 0 — 一个DeepSeek背景呼吸灯，随工作状态而改变
...
- `[可用]` [math-lean](https://github.com/Fisfzy/math-lean) 0 — dsh-lean-prover: Lean kernel-verified math reasoning plugin (DSH Cordis)
...
- `[可用]` [dsh-chrome](https://github.com/gemone/dsh-chrome) 2 — DeepSeek Harness plugin: model-facing Chrome DevTools Protocol (CDP) tools — nav
...
- `[不兼容]` [deepseek-harness.js](https://github.com/HologramSteve/deepseek-harness.js) 0 — A javascript port of my famous deepseek harness
...
- `[可用]` [jumpserver-dsh](https://github.com/jumpserver-east/jumpserver-dsh) 2 — DeepSeek Harness plugin: manage JumpServer assets and operate on them through Ko
...
- `[不兼容]` [dsh-plugin-doctor](https://github.com/lin-cheng-lab/dsh-plugin-doctor) 0 — DSH 插件体检：安装前检查 peer 版本兼容性，防止 rc 不匹配崩溃 🩺
...
- `[可用]` [dsh-balance-display](https://github.com/Liu-ty/dsh-balance-display) 0 — DeepSeek API balance overlay for DeepSeek Harness
...
- `[可用]` [dsh-port-guard](https://github.com/PangYiMing/dsh-port-guard) 0 — DSH plugin: triage port conflicts (reuse / switch / precise kill) — 端口占用处置
...
- `[不兼容]` [dsh-live-stats](https://github.com/Proton1917/dsh-live-stats) 0 — Live token estimates and true streaming TPS for DeepSeek Harness Web 〔PR〕
...
- `[未测]` [dsh-tool-describe-image](https://github.com/sala003/dsh-tool-describe-image) 4 — —
...
- `[可用]` [dsh-plugin-grok2api-media-tool](https://github.com/lsjspl/dsh-plugin-grok2api-media-tool) 2 — —
...
- `[可用]` [wps-dsh-plugin](https://github.com/CatNebulaaaa/wps-dsh-plugin) 4 — —
...
- `[可用]` [dsh-byok](https://github.com/raccoonBK/dsh-byok) 1 — DeepSeek Harness plugin: use any OpenAI-compatible provider with your own key, p
...
- `[可用]` [aureways](https://github.com/nullskymc/aureways) 4 — —
